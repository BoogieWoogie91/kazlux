...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Samsung Galaxy S7">
    <meta name="keywords" content="Samsung Galaxy S7, Купить телефон, Подарок близким,  Точная копия">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/s7slider1.png">
    </div>
    <div>
      <img src="img/s7slider2.png">
    </div>
    <div>
      <img src="img/s7slider3.png">
    </div>
    <div>
      <img src="img/s7slider1.png">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Samsung Galaxy S7</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhone6OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Samsung Galaxy S7</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Galaxy S7"/>
            <input type="hidden" name="price" value="29.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/galaxys7.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_galaxy7 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
...
<div class='advertisement'>
    <div class='content_1100'>
        ...
        <p class='mostPopularSub'>Samsung Galaxy S7 – полная реплика оригинала</p>
      <div class='row advertisementRow'>
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators iphoneIndicators">
              <li data-target="#carouselExampleIndicators" data-slide-to="0" class='blackIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="1" class='goldPlIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="2" class='whitePIndicator'></li>
            </ol>
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/black-front.png" alt="First slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/gold-front.png" alt="Second slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/white-front.png" alt="Second slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        ...
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          ...
          <div class='bestPhoneEver bestPhoneEver_2'>
            ...
            <p><span class='boldy bestPhoneBoldy'>Качественный экран</span><br>Устройство оснащено качественным дисплеем TFT от компании «Sharp» 
                                                  с разрешением QHD 1920*1080 пикселей</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3'>
              <p>A<span class='pink'>9</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Мощный процессор</span><br>Платформа Cortex-A7 Dual-core c 4-х ядерным процессором 
                                                                            мощным видео контроллером PowerVR SGX531</p>
          </div>
  ...
  <div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Samsung Galaxy S7</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Черный, белый, золотой</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span> 69.60 x 142.40 x 7.90 мм</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/web-design.png'>
              </div>
              <p><span class='boldy'>Интерфейс:</span> На смартфоне установлен Android KitKat</p>
            </li>
            <li>
              <div class='imgWrapper'>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> Li-ion, емкость 2400 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> Диагональ 5.1 дюймов, ёмкостный, Multi Touch</p>
            </li>
            <li>
              <div class='imgWrapper'>
            ...
            <li>
              ...
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> 5 мп, HD запись видео , авто фокус, LED-вспышка</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/gold-frontnback.png'>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='content_1100'>
      <div class='row equipmentRow'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 equipmentCol equipmentCol_1 noPad'>
          ...
          <p class='equipSub'>Полный комплект Samsung Galaxy S7</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-1 equipmentCol equipmentCol_2 equipmentCol_2_gals7'>
          <img src='img/samsung-3.png'>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
          </div>
        </div>
...
<div class='colorTypes gals7cols'>
    <div class='content_1100'>
      <h1>Цветовые решения</h1>
      <p class='colorSubs'>Выбери свой Samsung Galaxy S7</p>
      <div class='row colorTypesRow justify-content-between'>
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_1'>
          <div class='imgWrapper_6'>
            <img src='img/black-front.png'>
          </div>
            <p>Black Onyx</p>
            <div class='hidden_1'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/white-front.png'>
          </div>
            <p>White Pearl</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        ...
        <p class='rivalsSubs'>Samsung Galaxy S7 лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Смартфон Samsung Galaxy S7 (копия) не 
              имеет равных по популярности</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Оптимальные, эргономичные габариты корпуса 
              Samsung Galaxy S7 (копия), восхитительный внешний вид.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>С логотипами Samsung на корпусе сзади.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol gals7oRivalsCol_2'>
