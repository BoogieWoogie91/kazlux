...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой IPhone 6s">
    <meta name="keywords" content="Iphone 6, Купить телефон, Подарок близким,  Точная копия">
    <meta name="author" content="Denis Yakunin">
    <title>Iphone 6</title>
      <!-- Facebook Pixel Code  Pasha-->
<script>
  ...
  fbq('init', '2184632591589166');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=2184632591589166&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code  Pasha -->

<!-- Facebook Pixel Code Elena -->
<script>
  !function(f,b,e,v,n,t,s)
  {if(f.fbq)return;n=f.fbq=function(){n.callMethod?
  n.callMethod.apply(n,arguments):n.queue.push(arguments)};
  ...
  s.parentNode.insertBefore(t,s)}(window, document,'script',
  'https://connect.facebook.net/en_US/fbevents.js');
  fbq('init', '391019868140171');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=391019868140171&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code Elena -->
  </head>
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider iphoneSliders" id="slider">
    <div>
      <img src="img/iphone6slider1.png">
    </div>
    <div>
      <img src="img/iphone6slider2.png">
    </div>
    <div>
      <img src="img/iphone6slider3.png">
    </div>
    <div>
      <img src="img/iphone6slider1.png">
    </div>
...
<div class='orderThisNow'>
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой IPhone 6s</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhone6OrderThisNowCol_1ForPad  order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой IPhone 6s</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="IPhone6s"/>
            <input type="hidden" name="price" value="29.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/iphone6.html"/>
            <p>Ваше Имя</p>
            ...
            <div class='buttonWrap_3'>
              <button type='submit' class='purchaseFormButton'>Заказать</button>
            </div>
            </form>
          </div>
      </div>
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_iPhone6 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>29 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>59 800 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 orderThisNowCol orderThisNowCol_3 order-3 order-sm-3 order-md-3 order-lg-3 order-xl-3'>
        <h1>Как мы работаем</h1>
        <div class='howWeWork howWeWork_1'>
          <div class='imgWrap_11'>
            <img src='img/untitled-2.png' alt="report">
          </div>
          <p><span class='boldy'>Заявка</span><br>Вы оставляете<br>заявку на сайте</p>
        </div>
        <div class='howWeWork howWeWork_2'>
          <div class='imgWrap_12'>
            <img src='img/untitled-1.png' alt="confirm">
          </div>
        ...
        <div class='howWeWork howWeWork_3'>
          <div class='imgWrap_13'>
            <img src='img/untitled-3.png' alt="delivery">
          </div>
...
<div class='advertisement'>
    <div class='content_1100'>
        <h1 class='mostPopular'>Самый популярный мобильный телефон в мире</h1>
        <p class='mostPopularSub'>Apple iPhone 6s – полная реплика оригинала</p>
      <div class='row advertisementRow'>
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators iphoneIndicators">
              <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active graySpaceIndicator"></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="1" class='goldIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="2" class='pinkGoldIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="3" class='grayIndicator'></li>
            </ol>
            <div class="carousel-inner">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/bg_screen_1_black.png" alt="First slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/bg_screen_1_gold.png" alt="Second slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/bg_screen_1_rose.png" alt="Third slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/bg_screen_1_silver.png" alt="Fourth slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        </div>
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          <div class='bestPhoneEver bestPhoneEver_1 iphone6BestPhone_1'>
            <div class='iconCircle iconCircle_1'>
              <p>100<span class='pink'>%</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Точная копия</span><br>Устройство оснастили ярким экраном, мощным процессором, Play Market-ом. 
                                                  Точным внешним видом и полным соотвествием с знаменитым устройством.</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_2'>
            <div class='iconCircle iconCircle_2'>
              <p>Full<span class='pink'>HD</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Качественный экран</span><br>Устройство оснастили ярким экраном, мощным процессором, Play Market-ом. 
                                                  Точным внешним видом и полным соотвествием с знаменитым устройством.</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3'>
              <p>A<span class='pink'>9</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Мощный процессор</span><br>Процессор 4 ядра, 1200 mhz. MTK 6592.Cortex-A9. 
                                                  Полное сходство с  iOS 9.3</p>
          </div>
...
<div class='techParams'>
    <div class='content_1100'>
      <h1>Технические характеристики</h1>
      <p class='techSub'>Реплики Apple iPhone 6s</p>
      <div class='row techParamsRow align-items-center'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper'>
                <img src='img/painter-palette.png'>
              </div>
              <p><span class='boldy'>Цвет:</span> Серый космос, серебристый</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span> 67.1 x 138.3 x 7.1 мм</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/web-design.png'>
              </div>
              <p><span class='boldy'>Интерфейс:</span> Реализация интерфейса IOS на Android</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/settings.png'>
              </div>
              <p><span class='boldy'>Особенности:</span> Cим-карта формата Nano Sim</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/battery (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> Li-ion, емкость 2600 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> HD-дисплей Retina с разрешением 1334х750</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/icon (2).png'>
              </div>
              <p><span class='boldy'>Память:</span> 8Гб</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/camera-shutter.png'>
              </div>
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> Встроенная камера 8 Mpx, Фронтальная камера 3.2 Mpx</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/bg_screen_320.png'>
          </div>
        </div>
      </div>
    </div>
...
<div class='equipment'>
    <div class='content_1100'>
      <div class='row equipmentRow'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 equipmentCol equipmentCol_1 noPad'>
          <h1>Комплектация телефона</h1>
          <p class='equipSub'>Полный комплект Apple iPhone 6s</p>
          <ul class='equipmentList'>
            <li>
              <div class='imgWrapper_3'>
                <img src='img/headphones (1) copy.png'>
              </div>
              <p>Наушники с микрофоном</p>
            </li>
            <li>
              <div class='imgWrapper_3'>
                <img src='img/usb copy.png'>
              </div>
              <p>Lighting USB-кабель</p>
            </li>
            <li>
              <div class='imgWrapper_3'>
                <img src='img/layer_16.png'>
              </div>
              <p>Зарядное устройство</p>
            </li>
            <li>
              <div class='imgWrapper_4'>
                <img src='img/rec 6.png'>
              </div>
              <p>iPhone 6s на Аndroid 6</p>
            </li>
            <li>
              <div class='imgWrapper_5'>
                <img src='img/layer_15.png'>
              </div>
              <p>Фирменная упаковка</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-1 equipmentCol equipmentCol_2 iPhone6eqCol_2'>
          <img src='img/iPhone-65S-1.png'>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
          </div>
        </div>
...
<div class='colorTypes'>
    <div class='content_1100'>
      ...
      <p class='colorSubs'>Выбери свой Apple iPhone 6s</p>
      <div class='row colorTypesRow justify-content-between'>
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-3 colorTypesCol colorTypesCol_1'>
          <div class='imgWrapper_6'>
            <img src='img/compare_iphone6s_spacegray_large.png'>
          </div>
            <p>Серый Космос</p>
            <div class='hidden_1'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-3 colorTypesCol colorTypesCol_2'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/compare_iphone6s_silver_large.png'>
          </div>
            <p>Серебристый</p>
            <div class='hidden_2'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-3 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/compare_iphone6s_rosegold_large.png'>
          </div>
            <p>Розовое Золото</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-3 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/compare_iphone6s_gold_large.png'>
          </div>
            <p>Золотой</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        <h1>Не имеет конкурентов</h1>
        <p class='rivalsSubs'>Apple iPhone 6s лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Смартфон Apple iPhone 6s (копия) 
              не имеет равных по популярности!</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Оптимальные и эргономичные габариты корпуса 
              Apple iPhone 6s (копия), восхитительный внешний вид.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>С логотипами Apple на корпусе сзади.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Современные практичные материалы корпуса.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Содержит функции: управление жестами, 
              умная промотка экрана, умная пауза</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Язык интерфейса: русский, английский и др.
              (полностью русифицированная прошивка без ошибок).</p>
          </li>
        </ul>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol iPhone6noRivalsCol_2'>
...
<div class='supposedToMakeUbuy'>
    ...
    <p class='makeUbuySubs'>Прямые поставки без наценок реселлеров</p>
...
<div class='trueFeedbackBlock'>
    ...
    <script type="text/javascript">
        $(window).scroll(function() {
            ...
            if(height > 90){
                $('#rowTobeFixed').addClass('fixedRow');
            } else {
                /*Если меньше 100px удаляем класс для header*/
                $('#rowTobeFixed').removeClass('fixedRow');
            }
        });
    </script>
