...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Land Rover FLix X9">
    <meta name="keywords" content="Land Rover Flixx9, Купить телефон, Подарок близким,  Точная копия">
    <meta name="author" content="Denis Yakunin">
    <title>Land Rover Flixx9</title>
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/roverslider1.png">
    </div>
    <div>
      <img src="img/roverslider2.png">
    </div>
    <div>
      <img src="img/roverslider3.png">
    </div>
    <div>
      <img src="img/roverslider1.png">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Land Rover FLix X9</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhone6OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Land Rover FLix X9</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Land Rover Flix X9"/>
            <input type="hidden" name="price" value="29.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/landroverflixx9.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_LR order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>29 900тг.</p>
...
<div class='advertisement'>
    <div class='content_1100'>
        <h1 class='mostPopular'>Легендарный защищённый телефон с усиленным аккумулятором</h1>
        <p class='mostPopularSub'>Land-Rover Flix X9</p>
      <div class='row advertisementRow'>
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators iphoneIndicators">
              <li data-target="#carouselExampleIndicators" data-slide-to="0" class='greenIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="1" class='orangeIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="2" class='blueIndicator'></li>
            </ol>
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/affsafsasaf.png" alt="First slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/asfsafasfasf.png" alt="Second slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/afsfsafsasfsasaf.png" alt="Second slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        ...
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          <div class='bestPhoneEver bestPhoneEver_1 iphone6BestPhone_1'>
            ...
            <p><span class='boldy bestPhoneBoldy'>Точная копия</span><br>LAND ROVER X9 FLIP прошел сертификацию IP67 и обеспечивает 
                                                  защиту от попадания воды и пыли.</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_2'>
            <div class='iconCircle iconCircle_2'>
              <p>-40<span class='pink'>С</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Термоустойчивость</span><br>-40 °C - минимальная температура
                                                  85 °C - максимальная температура</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3'>
              <p class='wrapTheP'>72<span class='pink'> часа</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Мощный аккумулятор</span><br>Аккумуляторная батарея емкостью 16 800 мАч</p>
          </div>
...
<div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Land Rover Flix X9</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Оранжевый, зеленый, синий</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span> 118х62х23 мм</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/web-design.png'>
              </div>
              <p><span class='boldy'>Интерфейс:</span> На устройстве удобная оболочка </p>
            </li>
            <li>
              <div class='imgWrapper'>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> Два усиленных аккумулятора 16800 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> Внешний (320x240),  Внутренний сенсорный (320x240)</p>
            </li>
            <li>
              <div class='imgWrapper'>
            ...
            <li>
              ...
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> 3 Mpix. Cюжетные режимы, Zoom: 8х цифровой</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/asfsafasfasf.png'>
          </div>
        </div>
      </div>
    </div>
...
<div class='equipment'>
    <div class='content_1100'>
      <div class='row equipmentRow'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 equipmentCol equipmentCol_1'>
          <h1>Комплектация телефона</h1>
          <p class='equipSub'>Полный комплект Land Rover Flix X9</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-1 equipmentCol equipmentCol_2 equipmentCol_2_LR'>
...
<div class='colorTypes LRcols'>
    <div class='content_1100'>
      <h1>Цветовые решения</h1>
      <p class='colorSubs'>Выбери свой Flix X9</p>
      <div class='row colorTypesRow justify-content-between'>
        ...
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/afsfsafsasfsasaf.png'>
          </div>
            <p>Синий</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        ...
        <p class='rivalsSubs'>Land-Rover Flix X9 лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Защита от воды и попадания пыли IP67</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Единственный долгожитель в своем роде</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>2 Экрана (320x240)</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Русифицированная клавиатура</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol LRnoRivalsCol_2'>
