...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="BEAUTY BOX">
    <meta name="keywords" content="BEAUTY BOX, Товары для красоты, Товары для здоровья">
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>BEAUTY BOX</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 XtrimOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock'>
            ...
            <input type="hidden" name="tema" value="Beauty Box"/>
            <input type="hidden" name="price" value="9.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/beautybox.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_BB order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
...
<div class='justABlock'>
    <div class='content_1100'>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 noPad'>
                <div class='wrap_290'>
                    <img src='img/sup-1d.png'>
                </div>
                <p class='mus900 pink'>ПРАКТИЧНЫЙ</p>
                <p>Продуманные отделения позволят удобно расположить под рукой все самое необходимое</p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 noPad'>
                <div class='wrap_290'>
                    <img src='img/sup-2d.png'>
                </div>
                <p class='mus900 pink'>ФУНКЦИОНАЛЬНЫЙ</p>
                <p>Органайзер Beauty Box не занимает много места. Удобная модульная система позволит скомпоновать несколько наборов</p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 noPad'>
                <div class='wrap_290'>
                    <img src='img/sup-3d.png'>
                </div>
                <p class='mus900 pink'>НАДЕЖНЫЙ</p>
                <p>Прочные акриловые стенки не бьются при падении. Beauty Box легко можно помыть под проточной водой</p>
            </div>
        </div>
    </div>
</div>

<div class='noBootstrapBlock'>
    <div class='content_1100'>
        <h1>ОПИСАНИЕ ОРГАНАЙЗЕРА  BEAUTY BOX</h1>
        <div class='contentBlock'>
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 noPad'>
                    <div class='wrap_280'>
                        <img src='img/adsdasddsa.png'>
                    </div>
                </div>

                <div class='col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 noPad'>
                    <p>Вместительный акриловый органайзер Beauty Box позволит вам аккуратно организовать ваше пространство для ежедневного макияжа.<br><br>
                    Его продуманная конструкция позволяет вместить в себя все самое необходимое. Помады, тени, пудры, лаки, ювелирные украшения теперь всегда будут на своем месте, и вам не придется их долго искать среди гор хаотично лежащей косметики.<br><br>
                    Его стильный внешний вид гармонично впишется в абсолютно любой интерьер!</p>
                </div>
            </div>
        </div>
    </div>
...
<div class='qualities noPadQualit waistQualit'>
  <div class='content_1100'>
    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 noPad ForImgInside'>
        <img src='img/sfdfsdfssfd.png'>
      </div>
        <div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-7'>
            <h5 class='charsH5'>С органайзером Beauty Box вы навсегда забудете о беспорядке на вашем туалетном столике!</h5>
            <p class='blackpp'>Органайзер Beauty Box состоит из двух частей, которые вы можете скомпоновать по своему усмотрению. Верхняя часть состоит из 15 удобных слотов. Нижняя часть имеет 4 выдвижных отсека. Главной изюминкой этого органайзера является прозрачный акриловый корпус, который позволяет видеть и без труда, быстро находить всю вашу косметику.</p>
            <div class='flexBox'>
                <div class='flexContainer'>
                    <p><span class='pink mus700'>Цвет:</span> Прозрачный</p>
                    <p><span class='pink mus700'>Размеры:</span> 24 x 15 x 19 см</p>
                </div>

                <div class='flexContainer'>
                    <p><span class='pink mus700'>Материал: </span> акрил</p>
                    <p><span class='pink mus700'>Вес:</span> 1,5 кг</p>
                </div>
            </div>
      </div>
    </div>
...
<div class='supposedToMakeUbuy'>
  ...
  <div class='timerBlock'>
    <p>До конца акции осталось:</p>
    <script src="http://megatimer.ru/s/64d6c9d4d380b10ec79b8bda33924714.js"></script>
  </div>
...
<div class='purchase_block_BB'>
    <div class='content_1100'>
                <h1>BEAUTY BOX</h1>
                <p class='gaySubsBlack'>АКРИЛОВЫЙ ОРГАНАЙЗЕР ДЛЯ ХРАНЕНИЯ КОСМЕТИКИ</p>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_bb'>
