...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Apple IPhone 7">
    <meta name="keywords" content="IPhone 7, Купить телефон, Подарок близким,  Точная копия">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider iphoneSliders" id="slider">
    <div>
      <img src="img/iphone7slider1.png">
    </div>
    <div>
      <img src="img/iphone7slider2.png">
    </div>
    <div>
      <img src="img/iphone7slider3.png">
    </div>
    <div>
      <img src="img/iphone7slider1.png">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Apple IPhone 7</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhone6OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Apple IPhone 7</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="IPhone7s"/>
            <input type="hidden" name="price" value="29.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/iphone7.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_iPhone7 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>29 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>63 620 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='advertisement'>
    <div class='content_1100'>
        ...
        <p class='mostPopularSub'>Apple iPhone7 – полная реплика оригинала</p>
      <div class='row advertisementRow'>
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators iphoneIndicators">
              <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active pinkGoldIndicator"></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="1" class='blackIndicator'></li>
              <li data-target="#carouselExampleIndicators" data-slide-to="2" class='grayIndicator'></li>
            </ol>
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/iphone-gold.png" alt="First slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/iphone-black.png" alt="Second slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/iphone-white.png" alt="Third slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        ...
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          ...
          <div class='bestPhoneEver bestPhoneEver_2'>
            ...
            <p><span class='boldy bestPhoneBoldy'>Качественный экран</span><br>Устройство оснащено качественным HD-дисплеем Retina с разрешением 
                                                                              1334х750 как и на оригинальном iPhone 7</p>
          </div>
...
<div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Apple iPhone7</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Черный, белый</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span> 140mm x 68mm x 8mm</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/web-design.png'>
              </div>
              <p><span class='boldy'>Интерфейс:</span> Платформа Android 4.2 (обновляемая)</p>
            </li>
            <li>
              <div class='imgWrapper'>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> Li-ion, емкость 1500 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> Диагональ 4.7 дюймов, Ёмкостный, Multi Touch</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/icon (2).png'>
              </div>
              <p><span class='boldy'>Память:</span> 4GB + возможность увеличить за счет MicroSD карты</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/camera-shutter.png'>
              </div>
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> Запись видео, камера 5 Мп, авто фокус, LED-вспышка</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/iPhone7-silver.png'>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='content_1100'>
      <div class='row equipmentRow'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 equipmentCol equipmentCol_1 noPad'>
          ...
          <p class='equipSub'>Полный комплект Apple iPhone7</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-1 equipmentCol equipmentCol_2 iPhone7eqCol_2'>
          <img src='img/iphone-gold1.png'>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
          </div>
        </div>
...
<div class='colorTypes'>
    <div class='content_1100'>
      ...
      <p class='colorSubs'>Выбери свой Apple iPhone7</p>
      <div class='row colorTypesRow justify-content-between'>
        <div class='col-12  col-sm-12  col-md-6  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_1'>
          <div class='imgWrapper_6'>
            <img src='img/iphone-black.png'>
          </div>
            <p>Black</p>
            <div class='hidden_1'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_2'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/iphone-gold.png'>
          </div>
            <p>Gold</p>
            <div class='hidden_2'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/iphone-white.png'>
          </div>
            <p>White</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        ...
        <ul class='noRivalsList'>
          <li>
            ...
            <p>Смартфон Apple iPhone 7 (копия) 
          ...
          <li>
            ...
            <p>Оптимальные и эргономичные габариты корпуса 
              Apple iPhone 7 (копия), восхитительный внешний вид.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol iPhone7noRivalsCol_2'>
