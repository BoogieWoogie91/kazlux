...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Швейцарский рюкзак для путешествий и работы">
    <meta name="keywords" content="Swiss Gear, Качественная сумка, Подарок сумка, Купить сумку">
    <meta name="author" content="Denis Yakunin">
    <title>Swiss Gear</title>
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/sdfsdffsdfds.png">
    </div>
    <div>
      <img src="img/asfasfasfasfasfawfafs.png">
    </div>
    <div>
      <img src="img/asfasfaswfasfarfw.png">
    </div>
    <div>
      <img src="img/sdfsdffsdfds.png">
    </div>
...
<div class='bagFormBlock'>
  <div class='content_1100'>
    <h1 class='mostPopular'>Швейцарский рюкзак для путешествий и работы</h1>
    <p class='mostPopularSub'>+ SWISS GEAR часы в подарок</p>
    <div class='row bagFormRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 BagsFormCol_1'>
        <img src='img/chasi-swiss-army-v-yakutske.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4'>
        <div class='bagPriceCircle'>
          <div class='bagPriceInner'>
            <p>Цена со скидкой</p>
            <h5>18 990тг</h5>
            <p>Cтарая цена<br><span class='lineThrough'>40 405 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 orderThisNowCol_1'>
        <div class='form_lastBlock'>
          <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Swiss Gear"/>
            <input type="hidden" name="price" value="18.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/swissgear.html"/>
            <p>Ваше Имя</p>
...
<div class='techParamsForBags'>
    <div class='content_1100'>
      <h1>Xарактеристики Сумки</h1>
      <p class='techSub'>Кожаной мужской сумки Jeep</p>
      <div class='row techParamsRowForBags align-items-center'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='manufacturer5'><span class='boldy'>Цвет:</span> Черный</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p class='manufacturer6'><span class='boldy'>Размеры:</span>  48 х 30 х 27 см.</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/briefcase.png'>
              </div>
              <p><span class='boldy'>Тип:</span> Рюкзак</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/belt.png'>
              </div>
              <p class='manufacturer7'><span class='boldy'>Регулировка ремня:</span> Есть</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper_1 favoritesImgWrap'>
                <img src='img/favorites.png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Особенности:</span> Встроенная аэро-подушка в рюкзаке</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/zip.png'>
              </div>
              <p class='manufacturer8'><span class='boldy'>Материал:</span> Oxford</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/food-scale-tool.png'>
              </div>
              <p class='manufacturer9'><span class='boldy'>Объем:</span> 39л</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/3d-modeling.png'>
              </div>
              <p class='manufacturer10'><span class='boldy'>Модель:</span> Swiss Gear 8810</p>
            </li>
          </ul>
        </div>
...
<div class='whyBuyThisShit_swiss'>
  <div class='content_1100'>
    <h1>ПРЕИМУЩЕСТВА ДАННОГО РЮКЗАКА</h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/asgdsgssdggsd.png'>
        </div>
        <p>Ваш ноутбук будет
          надежно защищен</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/asfasfasfasfasfas3.png'>
        </div>
        <p>Каждая ваша вещь будет иметь свое место</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/lsdgihlsgkdjhglkjd.png'>
        </div>
        <p>Вместимость рюкзака можно регулировать</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/asffafewrhgedhr.png'>
        </div>
        <p>Кармана-сеточки для бутылочек и разных мелочей</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/sdgsdgsdgsdg.png'>
        </div>
        <p>Разъем для наушников на плечевом ремне</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-2 bagColumn'>
        <div class='imgWrapForBags_swiss'>
          <img src='img/augljhlgjhgv1.png'>
        </div>
        <p>Специальный сеточный карман на плечевом ремне для телефона</p>
      </div>
    </div>
  </div>
</div>
...
<div class='justAnotherAd'>
  <div class='content_1100'>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-6'>
        <div class='imgWrap_97'>
          <img src='img/asfasfljksdhkjsadh.png'>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-6'>
        <div class='imgWrap_98'>
          <img src='img/lksdgjlkdsghkjgh.png'>
        </div>
      </div>
    </div>
    <h1>Встроенная аэро-подушка в рюкзаке обеспечивает отличную циркуляцию воздуха, благодаря этому у вас никогда не будет потеть спина, что обеспечивает ещё больший комфорт</h1>
  </div>
</div>

<div class='techParamsForBags'>
    <div class='content_1100'>
      <h1>Xарактеристики Часов</h1>
      <p class='techSub'>Рюкзака Swiss Gear</p>
      <div class='row techParamsRowForBags align-items-center'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper dropWrap'>
                <img src='img/drop-silhouette.png'>
              </div>
              <p class='manufacturer'><span class='boldy'>Водозащита:</span> WR-30</p>
            </li>
            <li>
              <div class='imgWrapper gearWrapper'>
                <img src='img/settings-gears.png'>
              </div>
              <p><span class='boldy'>Механизм:</span> Кварц</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/wristwatch.png'>
              </div>
              <p class='manufacturer2'><span class='boldy'>Корпус:</span> Стальное Контейнер</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper_1 favoritesImgWrap'>
                <img src='img/circular-window.png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Стекло:</span> Минеральное</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/zip.png'>
              </div>
              <p class='manufacturer3'><span class='boldy'>Ремешок:</span> Тканевый (нейлон)</p>
            </li>
            <li>
              <div class='imgWrapper heightWrap'>
                <img src='img/height.png'>
              </div>
              <p class='manufacturer18'><span class='boldy'>Длина Ремешка:</span> 24см</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/chasi-swiss-army-v-yakutskedfsfsdffsdfsd.png'>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Швейцарский рюкзак для путешествий и работы</h1>
        <p class='alignLeftt hidable2'>+ SWISS GEAR часы в подарок</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 SwissOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Швейцарский рюкзак для путешествий и работы</h1>
        <p class='alignstart showable2'>+ SWISS GEAR часы в подарок</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Swiss Gear"/>
            <input type="hidden" name="price" value="18.990"/>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_swiss order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>18 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>40 405 тенге</span></p>
          </div>
        </div>
      </div>
