...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="ЛУЧШИЙ ГОРОДСКОЙ РЮКЗАК 2017 ГОДА С ЗАЩИТОЙ ОТ КАРМАННИКОВ">
    <meta name="keywords" content="Bobby, Качественная сумка, Подарок сумка, Купить сумку">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/fsasdgsdfsdffds.png">
    </div>
    <div>
      <img src="img/asffsasfsaf2.png">
    </div>
    <div>
      <img src="img/asffsafasafs4.png">
    </div>
    <div>
      <img src="img/fsasdgsdfsdffds.png">
    </div>
...
<div class='bagFormBlock'>
  <div class='content_1100'>
    <h1 class='mostPopular'>ЛУЧШИЙ ГОРОДСКОЙ РЮКЗАК 2017 ГОДА С ЗАЩИТОЙ ОТ КАРМАННИКОВ</h1>
    <p class='mostPopularSub'>+ Power Bank в подарок!</p>
    <div class='row bagFormRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-5 BagsFormCol_1_bobby'>
        <img src='img/productfdsfdfs.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-3'>
        <div class='bagPriceCircle bobbyPriceCircle'>
          <div class='bagPriceInner'>
            <p>Цена со скидкой</p>
            <h5>9 900тг</h5>
            <p>Cтарая цена<br><span class='lineThrough'>19 800 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 orderThisNowCol_1'>
        <div class='form_lastBlock'>
          <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Bobby"/>
            <input type="hidden" name="price" value="9.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/bobby.html"/>
            <p>Ваше Имя</p>
    ...
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 warPayDelCol'>
        <img src='img/dsgsdgsdgsdg.png'>
        <p>100% Гарантия качества</p>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 warPayDelCol'>
        <img src='img/asdgsdgsdggsd.png'>
        <p>Оплата при получении</p>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 warPayDelCol'>
        <img src='img/sdgsdsdggds.png'>
...
<div class='qualities green'>
  <div class='content_1100'>
    <h1 class='whiteh1'>01 НАДЕЖНЫЙ.</h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-5 qualities_col_1 noPad'>
        <img src='img/asfsaffsafssafsaf.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-8  col-xl-7'>
        <h1 class='whiteh1 forAdaptive'>Защита от карманников</h1>
        <p class='whitep'>Ежедневно в мире совершается более 400 тысяч мелких карманных краж. Теперь, благодаря специальному защищенному рюкзаку Bobby, вам не придется беспокоиться об этом.<br><br>
          Рюкзак Bobby надежно защищен от воришек, которые захотят разрезать ваш рюкзак (внутри есть специальные вставки), потайная застежка-молния и потайные карманы также будут держать ваши вещи в полной безопасности во время ваших поездок.<br><br>

          Рюкзак Bobby сконструирован так, что молния скрыта на тыльной стороне рюкзака, прилегающей к спине. Расстегнуть его, пока он на вашей спине, просто невозможно.</p>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">Получить консультацию</div></a>
          </div>
      </div>
    </div>
  </div>
...
<div class='qualities'>
  <div class='content_1100'>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-8  col-xl-7'>
        <h1 class='blackh1 addMargin'>02 НЕПРОРЕЗАЕМЫЙ.</h1>
        <h1 class='blackh1 moreAddMargin forAdaptive'>Защита от попыток разрезать рюкзак</h1>
        <p class='blackp'>Уникальное сочетание слоев, выполненных из разных материалов, надежно защитит ваши вещи. Вставка из цельного полипропилена создает твердый и надежный каркас, защищающий все, что находится внутри рюкзака и не даст разрезать рюкзак. Верхний слой – это стильная ткань из полиэстера. За ней идет слой мягкого материала, защищающего от ударов, а после - несколько слоев ткани, обеспечивающие дополнительную защиту.</p>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">Получить консультацию</div></a>
          </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-5 margincolumn qualities_col_1 noPad'>
        <img src='img/02-img.png'>
      </div>
    </div>
  </div>
</div>

<div class='qualities purple'>
  <div class='content_1100'>
    <h1 class='whiteh1'>03 РАСПРЕДЕЛЕНИЕ ВЕСА.</h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 qualities_col_1 noPad'>
        <img src='img/dgalksgdhlgaskd.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 qualities_col_2'>
        <h1 class='whiteh1 forAdaptive'>Правильное распределение веса</h1>
        <p class='whitep'>Дизайн рюкзака Bobby позволяет распределить вес так, что самые тяжелые предметы располагаются ближе всего к спине, а перегородки между отделениями не дают весу       перемещаться при движении. Благодаря этому решению снижается нагрузка на плечи, и вес рюкзака воспринимается на 20-25% меньше, чем при использовании стандартных моделей рюкзаков.</p>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">Получить консультацию</div></a>
          </div>
      </div>
...
<div class='qualities safety'>
  <div class='content_1100'>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-8  col-xl-7'>
        <h1 class='blackh1 addMargin'>04 Безопасность.</h1>
        <h1 class='blackh1 moreAddMargin forAdaptive'>Безопасность ночью</h1>
        <p class='blackp widthChanger'>Светоотражатели на рюкзаке сделают вас заметным на дороге в темного время суток, обезопасив таким образом вас от проезжающих машин.</p>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">Получить консультацию</div></a>
          </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-5 margincolumn qualities_col_1 noPad'>
        <img src='img/sfddsfasdfsdf.png'>
      </div>
    </div>
  </div>
</div>
...
<div class='qualities blue'>
  <div class='content_1100'>
    <h1 class='whiteh1'>05 Зарядка гаджетов. </h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 qualities_col_1 noPad'>
        <img src='img/dgalksgdhlgaskd.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 qualities_col_2'>
        <h1 class='whiteh1 forAdaptive'>USB - порт для зарядки вашего телефона</h1>
        <p class='whitep widthChange'>Для жителя мегаполиса очень критично быть на связи, поэтому разряженная батарейка на телефоне, может стать большой проблемой. Внешний USB-порт рюкзака Bobby Backpack позволит с легкостью подзарядить телефон в дороге. Нужно лишь подсоединить к кабелю внутри рюкзака свое зарядное устройство, и, когда вам будет необходимо, вы сможете, используя свой кабель, подключить телефон к USB – порту, расположенному на лямке рюкзака.</p>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">Получить консультацию</div></a>
          </div>
      </div>
...
<div class='colorTypes forBags'>
    <div class='content_1100'>
      <h1>Цветовые решения</h1>
      <p class='colorSubs'>Выбери свой рюзкак Bobby</p>
      <div class='row colorTypesRow justify-content-between'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/product-1asfsaffsa.png'>
          </div>
            <p>Black</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>ЛУЧШИЙ ГОРОДСКОЙ РЮКЗАК 2017 ГОДА 
                                        С ЗАЩИТОЙ ОТ КАРМАННИКОВ</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 BobbyOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock veryLastForm'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Bobby"/>
            <input type="hidden" name="price" value="9.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/bobby.html"/>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_bobby order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>9 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>19 800 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 orderThisNowCol orderThisNowCol_3 orderThisNowCol_3_bobby order-3 order-sm-3 order-md-3 order-lg-3 order-xl-3'>
