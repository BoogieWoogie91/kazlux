...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="ЛЕГЕНДАРНЫЕ ЧАСЫ HUBLOT">
    <meta name="keywords" content="Hublot+Tissot, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Hublot+Tissot</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/hublosotslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/hublosotslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/hublosotslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/hublosotslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>ЛЕГЕНДАРНЫЕ ЧАСЫ HUBLOT</h1>
        <p class='alignLeftt hidable2'>+ Часы TISSOT В ПОДАРОК</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 HublosotOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>ЛЕГЕНДАРНЫЕ ЧАСЫ HUBLOT</h1>
        <p class='alignstart showable2'>+ Часы TISSOT В ПОДАРОК</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Hublot + Tossot"/>
            <input type="hidden" name="price" value="17.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/hublotandtissot.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_hublosot order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>17 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>59 970 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Поклонники стильных высококачественных часов не смогут оставить без внимания одну из наиболее привлекательных моделей, купить которую хочется без промедлений. Сегодня элитные мужские аксессуары предлагаются в широком ассортименте, но именно часы Hublot, преимущества которых оценены в разных уголках мира, очаруют вас с первого взгляда.</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Hublot"</li>
          <li><span class='boldy'>Браслет:</span> Каучук</li>
          <li class='last'><span class='boldy'>Стекло:</span> Сапфировое</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> 440-ая нержавеющая сталь</li>
          <li><span class='boldy'>Механизм:</span> Кварцевые</li>
          <li class='last'><span class='boldy'>Вес:</span> 80г</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/1046762425_w640_h640_launch_of_the_big_bang.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='gallery hublosotGal'>
  <div class='content_1100_1'>
    <div class='row galleryRow'>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_66'>
          <div class='darkener'>
            <p>Смотреть видео обзор</p>
            <div class='aFuckingWrapper'>
            <button type="button" data-toggle="modal" data-target="#exampleModalCenter"><i class="far fa-play-circle"></i></button>
          </div>
          </div>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/hublosotgal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/hublosotgal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='goodGift'>
  <div class='row goodGiftRow'>
    <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 goodGiftCol goodGiftCol_1_hublosot'>
      <div class='wrapper_2'>
      <h1>Часы Tissot</h1>
      <h1 class='yellow'>Отличный подарок</h1>
      <h5>Часы Tissot</h5>
      <p> Стильные мужские наручные часы от легендарного бренда Tissot, 
          оснащенные корпусом из полированное гипоаллергенной стали и 
          прочнейшим сапфировым стеклом. Превосходный подарок 
          для любителей солидных аксессуаров.</p>
      <h5>Сделай себе мужской подарок - часы Tissot</h5>
      <p> Уже полтора века швейцарская компания Tissot является признанным
          лидером в часовой индустрии, а сам бренд Tissot – знаком качества. 
          По статистике, в Швейцарии 60% жителей имеют наручные часы Tissot (Тиссо). 
          В России и СНГ их знают и любят еще с давних времен, когда в 1866 году 
          Tissot стал официальным поставщиком Российского императорского двора и 
          изготавливал разнообразные карманные часы с выгравированными гербами 
          императорских российских полков. Некоторые из таких часов сегодня хранятся 
          в музее Ле-Локле (Швейцария).</p>
    </div>
    </div>
    <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 goodGiftCol goodGiftCol_2'>
      <div class='imgWrap_600'>
        <img src='img/tissotgift.png' alt="watch">
      </div>
      <div class='buttonWrap_2'>
        <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ СЕЙЧАС</div></a>
      </div>
    </div>
  </div>
</div>
...
<div class='parameters'>
    <div class='content_1366'>
    <div class='row parametersRow'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 parametersCol parametersCol_1'>
        <div class='floater'>
          <h1>Tissot</h1>
          <p>Мужские часы</p>
        </div>
        <div class='parametersTextWrap'>
        <div class='parametersText'>
          <p class='left'>Модель</p>
          <p class='right'>Мужская</p>
        </div>
        <div class='parametersText'>
          <p class='left'>Корпус</p>
          <p class='right'>Полированная гипоаллергенная сталь, сапфировое стекло</p>
        </div>
        <div class='parametersText'>
          <p class='left'>Браслет</p>
          <p class='right'>Кожаный ремешок с фирменной застежкой. </p>
        </div>
        <div class='parametersText'>
          <p class='left'>Водонепроницаемость</p>
          <p class='right'>Бытовая</p>
        </div>
        <div class='parametersText'>
          <p class='left'>Механизм</p>
          <p class='right'>Кварцевые</p>
        </div>
        <div class='parametersText'>
          <p class='left'>Цвет</p>
          <p class='right'>Черный</p>
        </div>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 offset-xl-1 parametersCol parametersCol_2_hublosot'>
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class='imgWrap_99'>
                <img class="d-block" src="img/130308419_w640_h640_black.png" alt="First slide">
              </div>
            </div>
...
<div class='supposedToMakeUbuy'>
    ...
    <p>Прямые поставки без наценок реселлеров</p>
...
<div class='trueFeedbackBlock'>
  ...
  <div class='purchase_block_hublosot'>
    <div class='content_1100'>
                <h1>ЛЕГЕНДАРНЫЕ ЧАСЫ HUBLOT</h1>
                <p class='hublosotP'>+ Часы TISSOT В ПОДАРОК</p>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
                <div class='form'>
                    <form action="form/integration.php" method="post">
                        <input type="hidden" name="tema" value="Hublot + Tissot"/>
                        <input type="hidden" name="price" value="17.990"/>
                        <input type="hidden" name="comments" value="http://kz-luxury.com/hublotandtissot.html"/>
                        <p>Ваше ФИО</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_hublosot'>
                <div>
                ...
                <div class='insidePicCol_hublosot'>
                    <img src="img/hublosotpic.png">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='content_1230'>
      <div class='row'>
        <div class='col-4 col-sm-4 col-md-2 col-lg-2 col-xl-3'>
          <img src='img/logo_lux_white.svg' alt="logo">
        </div>
        <div class='col-6 col-sm-6 col-md-8 col-lg-8 col-xl-8'>
          <p>"Luxury Shop" г.Москва, ул. Новоорловская, д. 5Б, 119633</p>
        </div>
        <div class='col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1'>
          <a href="#slider"><img class="arrowUp" src="img/arrow-up.png" alt="arrowup"></a>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/h686ty_DhLk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
