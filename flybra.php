      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_FB order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            ...
            <p>Старая цена:<br><span class='lineThrough'>18 940 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='noRivals flyBraRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair'>
        ...
        <ul class='noRivalsList'>
          <li>
            ...
            <p>Забудьте обо всех комплексах, связанных с формой груди</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Носите любимые платья и топы без бретелей</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Избавьтесь от впивающихся бретелек и застежек</p>
          </li>
          <li>
            <div class='imgWrapper'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol FBNoRivalsCol_2'>

      </div>
    </div>
  </div>

  <div class='howToUseFlyBra'>
  	<div class='content_1100'>
  		<h1>КАК ИСПОЛЬЗОВАТЬ?</h1>
  		<div class='row'>
  			<div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 noPad'>
  				<p>1 - Ослабьте шнуровку и наклейте силиконовые чашечки на грудь<br><br>

				2 - Затяните шнуровку, создавая идеальную 
				форму декольте<br><br>

				3 - Прижмите чашки руками на несколько секунд 
				для лучшей фиксации</p>
  			</div>

  			<div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-7 howToUseCol_2'>
  				<img src='img/asgafsasfafs.png'>
  			</div>
  		</div>
  		<h1>КАК ХРАНИТЬ FLY BRA?</h1>
  		<p>После использования промойте бюстгалтер в теплой воде с небольшим количеством мыла. Просушите чашечки естественным образом, без использования полотенца и наклейте защитную пленку до следующего применения.</p>
  	</div>
  </div>
