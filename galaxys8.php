...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Galaxy S8">
    <meta name="keywords" content="Galaxy S8, Купить телефон, Подарок близким,  Точная копия">
...
<div class='orderThisNow'>
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Galaxy S8</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 GalaxyS8OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Galaxy S8</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="galaxyS8"/>
            <input type="hidden" name="price" value="49.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/galaxys8.html"/>
            <p>Ваше Имя</p>
            <input class='purchaseFormInput' type="text" placeholder="Имя" name='name'>
            <p>Ваш Телефон</p>
            <input class='purchaseFormInput' type="text" placeholder="+7(777)888-00-00" name='phone' id='phone'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_galaxys8 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>49990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>73300 тенге</span></p>
          </div>
        </div>
      </div>
  ...
  <div class='advertisement'>
    <div class='content_1100'>
        ...
        <p class='mostPopularSub'>Samsung Galaxy S8 – полная реплика оригинала</p>
        ...
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
              <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active blackIndicator"></li>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="img/galaxyS8Black.png" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="img/galaxyS8Gold.png" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="img/galaxyS8Gray.png" alt="Third slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        </div>
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 '>
          <div class='bestPhoneEver bestPhoneEver_1'>
            <div class='iconCircle iconCircle_1'>
              <p>100<span class='pink'>%</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Точная копия</span><br>Устройство оснастили оригинальным интерфейсом на базе Android KitKat.<br>В комплекте с телефоном идет оригинальная гарнитура и зарядное устройство</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_2'>
            <div class='iconCircle iconCircle_2'>
              <p>Full<span class='pink'>HD</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Качественный экран</span><br>Устройство оснащено качественным дисплеем TFT от<br>Компании «Sharp» с разрешением QHD 1920*1080 пикселей</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3'>
              <p>A<span class='pink'>9</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Мощный процессор</span><br>Платформа Cortex-A9 Dual-core c 2-х ядерным процессором<br>мощным видео контроллером PowerVR SGX531</p>
          </div>
  ...
  <div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Samsung Galaxy S8</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Черный, золотой, металлический</p>
            </li>
            <li>
              <div class='imgWrapper'>
            ...
            <li>
              ...
              <p><span class='boldy'>Интерфейс:</span> Оригинальный, на базе Android KitKat</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/settings.png'>
              </div>
              <p><span class='boldy'>Особенности:</span> 1 sim-карта формата Micro Sim</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            ...
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Экран:</span> Диагональ 5.8 дюймов, ёмкостный, Multi Touch</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/icon (2).png'>
              </div>
              <p><span class='boldy'>Память:</span> Возможность увеличить память за счет MicroSD карты</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/camera-shutter.png'>
              </div>
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> 5 мп, запись видео , авто фокус, LED-вспышка</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/galaxy-s8-front-view-black-v1.png'>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class='equipment'>
    <div class='content_1100'>
      <div class='row equipmentRow'>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-3 equipmentCol equipmentCol_2'>
          <img src='img/layer_9.png'>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
          </div>
        </div>
  ...
  <div class='colorTypes'>
    <div class='content_1100'>
      ...
      <p class='colorSubs'>Выбери свой Samsung Galaxy S8</p>
      <div class='row colorTypesRow justify-content-between'>
        <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 colorTypesCol colorTypesCol_1'>
          <div class='imgWrapper_6'>
            <img src='img/galaxyS8Black.png'>
          </div>
            <p>Midnight Black</p>
            <div class='hidden_1'>
            <div class='buttonWrap_1'>
  ...
  <div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        ...
        <p class='rivalsSubs'>Samsung Galaxy S8 лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Смартфон Samsung Galaxy S8 (копия)<br>не имеет равных по популярности!</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Оптимальные и эргономичные габариты корпуса<br>Samsung Galaxy S8 (копия), восхитительный внешний вид.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
          ...
          <li>
            ...
            <p>Содержит функции: управление жестами,<br>умная промотка экрана, умная пауза.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Язык интерфейса: русский, английский и др.<br>(полностью русифицированная прошивка без ошибок).</p>
          </li>
        </ul>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_2'>
