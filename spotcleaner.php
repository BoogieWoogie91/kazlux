...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="SPOT CLEANER">
    <meta name="keywords" content="SPOT CLEANER, Товары для красоты, Товары для здоровья">
    <meta name="author" content="Denis Yakunin">
    <title>Spot Cleaner</title>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>SPOT CLEANER</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 spotCleanerOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Spot Cleaner"/>
            <input type="hidden" name="price" value="10.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/spotcleaner.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_SC order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>10 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>23 385 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='supposedToMakeUbuy spotcleanerBuyRow'>
    <div class='content_1100'>
    <h1>Почему стоит выбрать</h1>
    <div class='row buyThisPlsRow'>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_1'>
        <div class='imgWrap_204'>
          <img src='img/block-2-icon1.png'>
        </div>
        <p><span class='boldy'>SPOT CLEANER</span><br> в комплексе, убирают черные точки, комедоны, сальные пробки, акне</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_2'>
        <div class='imgWrap_204'>
          <img src='img/block-2-icon2.png'>
        </div>
        <p><span class='boldy'>SPOT CLEANER</span><br> осуществляет вакуумный массаж поверхностных слоев кожи лица</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_3'>
        <div class='imgWrap_204'>
          <img src='img/block-2-icon3.png'>
        </div>
        <p><span class='boldy'>SPOT CLEANER</span><br> стимулирует кровообращение в клетках кожи, обновляя их</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_4'>
        <div class='imgWrap_204'>
          <img src='img/block-2-icon4.png'>
        </div>
        <p><span class='boldy'>SPOT CLEANER</span><br> вытягивает из пор и прыщей токсины, вредные микроорганизмы и мертвые клетки</p>
      </div>
    </div>
  </div>
</div>

    <div class='buttonWrap_1 gayWrap'>
      <a href="#form"><div class="buttonChanger">Получить Консультацию</div></a>
    </div>


<div class='supposedToMakeUbuy amazingResults'>
    <div class='content_1100'>
    <h1>Результаты просто вдохновляющие!</h1>
    <div class='row makeUbuyRow'>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 makeUbuyCol noPad'>
        <div class='imgWrap_316'>
          <img src='img/agsgdsgd.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 makeUbuyCol noPad'>
        <div class='imgWrap_316'>
          <img src='img/asddasdsadasds.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 makeUbuyCol noPad'>
        <div class='imgWrap_316'>
          <img src='img/asddsadsaadsdsa.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='noRivals spotcleanerRivals'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair'>
        ...
        <ul class='noRivalsList spotcleanRL'>
          ...
          <li>
            ...
            <p>Удаляет угри, комедоны, акне</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Можно пользоваться каждый день</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Вы тратитесь на покупку прибора</p>
          </li>
            <li>
            <div class='imgWrapperForGreenShit'>
              <img src='img/dsffsdsffsdsfd.png'>
            </div>
          </li>
        </ul>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol SCNoRivalsCol_2'>
  ...
  <div class='whatProsDoThink'>
      <div class='content_1100'>
        <h1>ЧТО ДУМАЮТ О SPOT CLEANER ПРОФЕССИОНАЛЬНЫЕ КОСМЕТОЛОГИ?</h1>
        <p>Вакуумная чистка — самая передовая технология во Франции и Европе. Вакуумная чистка совсем недавно появилась на рынке косметологического оборудования. Это дорогостоящие, массивные аппараты для косметологических кабинетов.<br><br>Тем более удивительно, что появился Spot Cleaner для домашнего пользования. Такое маленькое устройство, а эффект тот же — избавление от черных точек, акне и комедонов, омоложение кожи!</p>
        <div class='buttonWrap_1 prosWrap'>
          <a href="#form"><div class="buttonChanger">Заказать в один клик</div></a>
        </div>
...
<div class='supposedToMakeUbuy'>
    <div class='content_1100'>
    <h1>СДЕЛАТЬ КОЖУ ЧИСТОЙ? ЭТО ПРОСТО!</h1>
    <div class='row buyThisPlsRow'>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_1'>
        <div class='imgWrap_225'>
          <img src='img/block-7-icon1.png'>
        </div>
        <p><span class='boldy'>Очистите кожу любым косметическим средством, которое подходит вашей коже</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_2'>
        <div class='imgWrap_225'>
          <img src='img/block-7-icon2.png'>
        </div>
        <p><span class='boldy'>Очистите кожу любым косметическим средством, которое подходит вашей коже</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_3'>
        <div class='imgWrap_225'>
          <img src='img/block-7-icon3.png'>
        </div>
        <p><span class='boldy'>Очистите кожу любым косметическим средством, которое подходит вашей коже</p>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 makeUbuyCol makeUbuyCol_4'>
        <div class='imgWrap_225'>
          <img src='img/block-7-icon4.png'>
        </div>
        <p><span class='boldy'>Очистите кожу любым косметическим средством, которое подходит вашей коже</p>
      </div>
    </div>
    ...
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class=''>SPOT CLEANER</h1>
                <p class='gaySubs'>ВАШ ДОМАШНИЙ КОСМЕТОЛОГ</p>
