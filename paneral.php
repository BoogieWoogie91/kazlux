...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="ЧАСЫ «PANERAI LUMINOR» ВЫБОР УСПЕШНЫХ МУЖЧИН">
    <meta name="keywords" content="PANERAI LUMINOR, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>PANERAI LUMINOR</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/asdadsdsadsasadsadsad.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/dfsfsdfsdsdfsfdsdfdfssdf.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/asddsadsasadsaddsasda.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/asdadsdsadsasadsadsad.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>ЧАСЫ «PANERAI LUMINOR» ВЫБОР УСПЕШНЫХ МУЖЧИН</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 korsOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>ЧАСЫ «PANERAI LUMINOR» ВЫБОР УСПЕШНЫХ МУЖЧИН</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="PANERAI LUMINOR"/>
            <input type="hidden" name="price" value="8.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/paneral.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_PAN order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>8 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>29 670 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Часы «Panerai Luminor» - олицетворение статуса и успеха, чувства стиля, вкуса и самодостаточности.
                      Это нечто большее, чем просто часы, это шедевры высокого часового искусства, которое зародилось 
                      в прекрасной Швейцарии. Возьмите с собой часы «Panerai Luminor» на деловую встречу, занятия спортом, 
                      на отдых или просто носите их в повседневной жизни и они будут дарить Вам только приятные эмоции,
                      восхищения со стороны женщин и уважение со стороны мужчин!
                      </p>
      <div class='charLists_PAN'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "PANERAI LUMINOR"</li>
          <li><span class='boldy'>УНИВЕРСАЛЬНОСТЬ:</span> Подойдут как под классику, так и под стиль casual</li>
          <li><span class='boldy'>УДОБНЫЙ РЕМЕШОК:</span> Не деформируется при ношении и долго служит</li>
          <li><span class='boldy'>МАТЕРИАЛ:</span> Гиппоаллергенная сталь</li>
          <li><span class='boldy'>НАДЕЖНОЕ СТЕКЛО:</span> Сапфировое и противоударное с антибликовым покрытием</li>
          <li class='last'><span class='boldy'>ФОСФОРНОЕ НАПЫЛЕНИЕ:</span> Стильная подсветка позволит узнать время даже в темное время суток</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/lyumsddsdssdinor2.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='gallery korsGal'>
  <div class='content_1100_1'>
    <div class='row galleryRow'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 galleryCol'>
...
<div class='purchase_block_PAN'>
    <div class='content_1100'>
                <h1>МУЖСКИЕ ЧАСЫ PANERAI LUMINOR</h1>
        <div class='row purchaseRow'>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_kors'>
                <div>
                ...
                <div class='insidePicCol_kors'>
                    <img src="img/lyuminor2.png">
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/omNo5ObiqPg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
