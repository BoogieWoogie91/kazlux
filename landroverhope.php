...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Land Rover Hope">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/afsfafasfasfasf.png">
    </div>
    <div>
      <img src="img/asffasfasfasf.png">
    </div>
    <div>
      <img src="img/sgdfdghdsfhsdfh.png">
    </div>
    <div>
      <img src="img/afsfafasfasfasf.png">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Land Rover Hope</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhone6OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Land Rover Hope</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Land Rover Hope"/>
            <input type="hidden" name="price" value="29.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/landroverhope.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_LRH order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
...
<div class='advertisement'>
    <div class='content_1100'>
        <h1 class='mostPopular'>Телефон-зарядка 2 в 1</h1>
        <p class='mostPopularSub'>Land Rover Hope</p>
      <div class='row advertisementRow'>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/phone1.png" alt="First slide">
              </div>              
            </div>
          </div>     
        </div>
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          <div class='bestPhoneEver bestPhoneEver_1 iphone6BestPhone_1'>
            <div class='iconCircle iconCircle_1 noRechargreCircle'>
              <p>10000<span class='pink'> mAh</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>PowerBank</span><br>Cверхмощная батарея емкостью 10000mAh  
                                                  что позволит эксплуатировать телефон без подзарядки практически месяц</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_2'>
            <div class='iconCircle iconCircle_2 twoCardsCircle'>
              <img src=img/drop-silhouette.png>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Водонепроницаемый</span><br>Можете смело ронять его в воду - он водонепроницаемый!</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3 twoToolsCircle'>
              <img src=img/tools-cross-settings-symbol-for-interface.png>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Противоударный</span><br>Телефон спокойно выдерживает даже сильные прямые удары, 
                                                  а также при падении с 2-х и более метров</p>
          </div>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Черный</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span> 131*63*27 мм</p>
            </li>
            <li>
              <div class='imgWrapper'>
            ...
            <li>
              ...
              <p><span class='boldy'>Особенности:</span> 2 Cим-карты стандартного формата</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2 techParamsCol_2_LRH'>
          <ul class='paramsList'>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/battery (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> 10000 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> 1.8 дюйма (640×480)</p>
            </li>
            <li>
              <div class='imgWrapper'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_LRH'>
        <h1>Не имеет конкурентов</h1>
        <p class='rivalsSubs'>Land-Rover Hope лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Можно использовать в качестве запасного телефона, 
              храня его в бардачке и заряжая когда необходимо 
              свой основной гаджет</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Телефон спокойно выдерживает даже сильные 
              прямые удары, а также при падении с 2-х и более метров</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Можете смело ронять его в воду - он водонепроницаемый!</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Телефон оборудован мощным фонариком, который 
              помогает ориентироваться на местности в ночное время суток</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Батарея телефона не разрядится во время Вашего недельного
              тура по Европе! Возможность использовать 2 sim карты</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Благодаря ударопрочному корпусу и водонепроницаемости 
              Вы с уверенностью можете заниматься любыми видами 
              экстремального спорта</p>
          </li>
        </ul>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol LRHnoRivalsCol_2'>
