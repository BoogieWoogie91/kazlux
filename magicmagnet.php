...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Детский развивающий Конструктор Magical Magnet">
    <meta name="keywords" content="Magic Magnets, Товары для детей, детские игрушки">
    <meta name="author" content="Denis Yakunin">
    <title>Magic Magnets</title>
    ...
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class=''>Детский развивающий Конструктор Magical Magnet</h1>
                <p class='gaySubs'>Закажи сейчас со скидкой 53%</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Magic Magnets"/>
                    <input type="hidden" name="price" value="7.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/magicmagnets.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_MM'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>7 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>19 750 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='content_1100'>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 noPad'>
                <h1>Что такое  Магнитный Конструктор Magical Magnet</h1>
                <p>Это целый мир в одной коробке. Это небоскребы и автомобили- трансформеры, роботы и невообразимые геометрические фигуры, ракеты и космические корабли, которые с удовольствием соберёт ваш ребёнок сам. Это развивающий  конструктор нового поколения!<br><br>Он состоит из деталей простых геометрических форм: треугольников, квадратов, ромбов и многих других, которые легко соединяются между собой силой магнитного притяжения. Магниты свободно вращаются внутри, поэтому могут соединяться любой стороной.
                </p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-5 offset-xl-1'>
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/G9fn03-rnUA" class='weirdWorkingVideo' frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>

<div class='IllMakeItFlex'>
    <img src='img/sffsfsfsfssafsdf.png'>
</div>


<div class='whatToDoWithThis'>
    <div class='content_1100'>
        <h1>Что можно сделать с помощью конструктора Magical Magnet?</h1>
        <div class='row'>
           <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 noPad'>
               <div class='wrap_243'>
                   <img src='img/fdsfsfsdfs.png'>
               </div>
           </div>

           <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 noPad'>
               <div class='wrap_243'>
                   <img src='img/fsdfsdfsdfsdf.png'>
               </div>
           </div> 

           <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 noPad'>
               <div class='wrap_243'>
                   <img src='img/asddsadsasadsda.png'>
               </div>
           </div> 

           <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 noPad'>
               <div class='wrap_243'>
                   <img src='img/gsadfasseweasdf.png'>
               </div>
           </div>  
        </div>
        <div class='row'>
...
<div class='orderThisNow'>
  <div class='content_1366'>
    ...
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_MM order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
