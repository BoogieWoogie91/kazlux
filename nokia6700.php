...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой Nokia 6700">
    <meta name="keywords" content="Nokia 6700, Купить телефон, Подарок близким,  Точная копия">
    <meta name="author" content="Denis Yakunin">
    <title>Nokia 6700</title>
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider NOKIAsliders" id="slider">
    <div>
      <img src="img/saddsaadssadsad.png">
    </div>
    <div>
      <img src="img/sdffsdsfdsdfsdf.png">
    </div>
    <div>
      <img src="img/asffasfsaafsfsafs.png">
    </div>
    <div>
      <img src="img/saddsaadssadsad.png">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой Nokia 6700</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 NokiaOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой Nokia 6700</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Nokia 6700"/>
            <input type="hidden" name="price" value="19.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/nokia6700.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_nokia6700 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>19 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>49 975 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='advertisement'>
    <div class='content_1100'>
        ...
        <p class='mostPopularSub'>Nokia 6700 – полная реплика оригинала</p>
      <div class='row advertisementRow'>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/phone_1.png" alt="First slide">
              </div>              
            </div>
          </div>     
        </div>
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          <div class='bestPhoneEver bestPhoneEver_1 iphone6BestPhone_1'>
            ...
            <p><span class='boldy bestPhoneBoldy'>Точная копия</span><br>Из нержавеющей стали, который не стирается. Стальная округлая
                                                  рамка надежно защищает детали аппарата от повреждений.</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_2'>
            <div class='iconCircle iconCircle_2 twoCardsCircle'>
              <img src=img/1222299.png>
            </div>
            <p><span class='boldy bestPhoneBoldy'>2 SIM-КАРТЫ</span><br>Тонкий, легкий и стильный телефон на две SIM-карты. 
                                                  Одновременно поддерживает работу 2-х SIM-карт в режиме ожидания.</p>
          </div>
          <div class='bestPhoneEver bestPhoneEver_3'>
            <div class='iconCircle iconCircle_3'>
              <p>1<span class='pink'>2</span></p>
            </div>
            <p><span class='boldy bestPhoneBoldy'>Гарантия 12 месяцев</span><br>Сделано в Корее! Мы соблюдаем Закон "О защите прав потребителей",
                                                  и в течение 14 дней после получения покупки Вы можете вернуть свои деньги, 
                                                  связавшись с нашими менеджерами. Мы без лишних вопросов примем Ваш возврат!</p>
          </div>
...
<div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Nokia 6700</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p><span class='boldy'>Цвет:</span> Золотой</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p><span class='boldy'>Размеры телефона:</span>  105 х 45 х 11 мм</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/web-design.png'>
              </div>
              <p><span class='boldy'>Интерфейс:</span> Стандартная оболочка Nokia</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/settings.png'>
              </div>
              <p><span class='boldy'>Особенности:</span> 2 Cим-карты</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Аккумулятор:</span> Li-ion, емкость 1200 мАч</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/icon (1).png'>
              </div>
              <p class='moreMargin'><span class='boldy'>Экран:</span> 6500 цветов TFT True Colour</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/icon (2).png'>
              </div>
              <p><span class='boldy'>Память:</span> Расширенная microSD, до 8 Гб</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/camera-shutter.png'>
              </div>
              <p class='moreMargin_1'><span class='boldy'>Камера:</span> 5 мп</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/phone_7.png'>
          </div>
        </div>
      </div>
    </div>
