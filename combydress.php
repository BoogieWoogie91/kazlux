...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Slim Shapewear">
    <meta name="keywords" content="Slim Shapewear, Товары для красоты, Товары для здоровья">
    <meta name="author" content="Denis Yakunin">
    <title>Slim Shapewear</title>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Slim Shapewear</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 BobbyOrderThisNowCol_1 combydressCol order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Slim Shapewear"/>
            <input type="hidden" name="price" value="7.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/combydress.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_CD order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
...
<div class='morePissingInEars'>
    <div class='content_1100'>
        <div class='row align-items-end'>
            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pissingInEarsCol'>
                <div class='q220Wrap'>
                    <img src='img/argument_item_1.png'>
                </div>
                <p>Хотите выглядеть<br> стройно и подтянуто?</p>
            </div>

            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pissingInEarsCol'>
                <div class='q260Wrap'>
                    <img src='img/argument_item_2.png'>
                </div>
                <p>Хотите носить облегающую одежду,<br> не стесняясь своих форм?</p>
            </div>

            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pissingInEarsCol'>
                <div class='q220Wrap'>
                    <img src='img/argument_item_3.png'>
                </div>
                <p>Хотите скрыть<br> недостатки фигуры?</p>
            </div>
        </div>
    </div>
</div>
...
<div class='bullshittery'>
    <div class='content_1100'>
        <h1>Комбидресс преобразит вашу фигуру!</h1>
        <p class='bullshitteryp'>Slim Shapewear</p>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 bullshitteryCol'>
               <img src='img/conversion_1.png'> 
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 bullshitteryCol noPadCol'>
               <p><span class='mus500'>Комбидресс эффективно борется с проблемными зонами:</span><br>
                1. Живот становится плоским;<br>
                2. Бедра и ягодицы подтягиваются;<br>
                3. Складки под мышцами и на спине разглаживаются.<br><br>

                <span class='mus500'>Утягивающее белье Slim Shapewear дарит вам красоту и комфорт на весь день:</span><br>
                1. Дышащая ткань дает ощущение свежести;<br>
                2. Плотное прилегание к телу создает эффект «невидимки»;<br>
                3. Белье приятно носить — никакого раздражения и дискомфорта;<p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 bullshitteryCol'>
                <img src='img/conversion_3.png'>
            </div>
        </div>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair'>
        <h1>Почему корректирующее белье настолько эффективно?</h1>
        <p class='rivalsSubs'>Slim Shapewear</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Особая конфигурация лифа приподнимает грудь, 
делая её красивой и соблазнительной.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Эластичная ткань на поясе изящно очерчивает 
линию талии.</p>
          </li>
          <li>
            <div class='imgWrapper'>
            ...
            <p>Задняя вставка скрывает жировые складки и 
поддерживает мышцы спины.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Вшитый треугольник из плотной ткани подтягивает 
живот, убирая все неровности.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Эластичные вставки из специального материала 
моделируют форму бедер и ягодиц.</p>
          </li>
        </ul>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol CDNoRivalsCol_2'>
    ...
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>Slim Shapewear</h1>
                <p class='gaySubsWhite'>Комбидресс для коррекции вашей фигуры</p>
