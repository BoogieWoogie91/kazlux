...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="ЗАКАЖИ Tag Heuer Grand Carrera Calibre 17">
    <meta name="keywords" content="Tag Heuer 17, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Tag Heuer 17</title>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>ЗАКАЖИ Tag Heuer Grand Carrera Calibre 17</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 TagOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>ЗАКАЖИ Tag Heuer Grand Carrera Calibre 17</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="tag"/>
            <input type="hidden" name="price" value="49.500"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/tag_integral.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_tag order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1_tag'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>8900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>29670 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Tag"</li>
          <li><span class='boldy'>Браслет:</span> Кожа</li>
          <li class='last'><span class='boldy'>Стекло:</span> Минеральное</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> Часовая сталь</li>
          <li><span class='boldy'>Механизм:</span> Кварцевый</li>
          <li class='last'><span class='boldy'>Вес:</span> 90гр</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_21'>
          <img src='img/29501650_w640_h640_webzoomgc3cav5__ge_4kulood.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='gallery tagGal'>
  <div class='content_1100_1'>
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_27'>
          <img src='img/layer_46.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_28'>
          <img src='img/layer_43.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='trueFeedbackBlock'>
  ...
  <div class='purchase_block_tag'>
  <div class='content_1100'>
      <h1 class='hidable'>Tag Heuer Grand Carrera Calibre 17</h1>
      <p class='hidable'>Современные и стильные часы</p>
  <div class='row purchaseRow'>
    <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-6 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
      <div class='form'>
        ...
        <input type="hidden" name="tema" value="tag"/>
        <input type="hidden" name="price" value="49.500"/>
        <input type="hidden" name="comments" value="http://kz-luxury.com/tag.html"/>
        <p>Ваше ФИО</p>
    ...
    <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-6 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>

      <div class='insidePicCol_tag17'>
      ...
      <h1 class='showable'>Tag Heuer Grand Carrera Calibre 17</h1>
      <p class='showable'>Современные и стильные часы</p>        
     </div>
    </div>
  </div>
  </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/jWpKzdBNSQQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
