...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Anne kleinе Изысканные женские часы">
    <meta name="keywords" content="ANNE, ClEINE, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Anne Cleine</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/cleineslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/cleineslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/cleineslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/cleineslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Anne kleinе Изысканные женские часы</h1>
        <p class='alignLeftt hidable2'>в наборе с браслетами</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 CleineOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Anne kleinе Изысканные женские часы</h1>
        <p class='alignstart showable2'>в наборе с браслетами</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Anne Cleine"/>
            <input type="hidden" name="price" value="14.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/annecleine.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_cleine order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>14 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>51 380 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Часы с браслетами Anne klein – воплощение изысканности и элегантности. 
                        Они предназначены для модниц, стремящихся безупречно одеваться и носить 
                        стильные аксессуары. Часы данного бренда отличаются точностью и надежностью.</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Anne Clein"</li>
          <li><span class='boldy'>Браслет:</span> сталь</li>
          <li class='last'><span class='boldy'>Стекло:</span> Сапфировое</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> Высокотехн. сплав из нержавеющей стали</li>
          <li><span class='boldy'>Механизм:</span> Кварцевые</li>
          <li class='last'><span class='boldy'>Диаметр циферблата:</span> 35мм</li>
        </ul>
      </div>
      </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/review-big-item-01.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/review-big-item-02.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='purchase_block_cleine'>
    <div class='content_1100'>
                <h1>Anne kleinе Изысканные женские часы</h1>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
                <div class='form'>
                    <form action="form/integration.php" method="post">
                        <input type="hidden" name="tema" value="Anee Cleine"/>
                        <input type="hidden" name="price" value="14.900"/>
                        <input type="hidden" name="comments" value="http://kz-luxury.com/aneecleine.html"/>
                        <p>Ваше ФИО</p>
                        <input class='purchaseFormInput' type="text" placeholder="Имя" name='name'>
                        <p>Ваш Телефон</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_cleine'>
                <div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/oA_OC1u_p2k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
