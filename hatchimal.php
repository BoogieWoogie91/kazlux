...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="МИРОВАЯ ИГРУШКА ТЕПЕРЬ В КАЗАХСТАНЕ!">
    <meta name="keywords" content="Hatchimals, Товары для детей, детские игрушки">
    <meta name="author" content="Denis Yakunin">
    <title>Hatchimals</title>
...
<div class='purchase_block_hachmal'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>МИРОВАЯ ИГРУШКА ТЕПЕРЬ В КАЗАХСТАНЕ!</h1>
                <p class='gaySubsWhite'>СЮРПРИЗ ВНУТРИ</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Hatchimal"/>
                    <input type="hidden" name="price" value="12.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/hatchimals.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_hachmal'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>12 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>27 450 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='toyDescription'>
        <div class='content_1100'>
            <h1>ОПИСАНИЕ ИГРУШКИ HATCHIMALS</h1>
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'>
                    <div class='wrap_90_1'>
                        <img src='img/b2_1.png'>
                    </div>
                    <p>Для детей, которые любят чудеса и сюрпризы и хотят ухаживать за маленьким питомцем.</p>
                </div>
                ...
                <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'>
                    ...
                    <p>Ребенок сам запускает чудесные превращения этой игрушки.</p>
                </div>
                ...
                <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'>
                    ...
                    <p>Дарит прекрасный опыт по уходу за маленьким питомцем, учит заботе и любви.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class='WTFifThis'>
    <div class='content_1100'>
        <h1>Что такое игрушка Hatchimals?</h1>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators iphoneIndicators">
                  <li data-target="#carouselExampleIndicators" data-slide-to="0" class="red hachmalIndicator"><img src='img/fsfssfsfsfsfsf.png'></li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="1" class='pink hachmalIndicator'><img src='img/asffasafsafssaf.png'></li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="2" class='blue hachmalIndicator'><img src='img/dsdsdsdsdads.png'></li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="3" class='darkblue hachmalIndicator'><img src='img/sfaasfasfasffsa.png'></li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item iphoneItem active">
                    <img class="d-block w-100" src="img/dsadsadasadadsads.png" alt="First slide">
                  </div>
                  <div class="carousel-item iphoneItem">
                    <img class="d-block w-100" src="img/sdasdadasddsa.png" alt="Second slide">
                  </div>
                  <div class="carousel-item iphoneItem">
                    <img class="d-block w-100" src="img/adsdasdsadsasadsda.png" alt="Third slide">
                  </div>
                  <div class="carousel-item iphoneItem">
                    <img class="d-block w-100" src="img/fsdfsdsfdsdfdsf.png" alt="Fourth slide">
                  </div>
                </div>
              </div>
            </div>

            <div class='col-12  col-sm-12  col-md-12  col-lg-8  col-xl-7 offset-xl-1 advertisementCol ToysAdCol noPad'>
                <p>Это игрушка-сюрприз. В момент ее приобретения невозможно заранее узнать кто же будет внутри. В каждом яйце может быть один из двух вариантов птенца Пингвина.<br><br>Всего у птенцов Hatchimal 4 этапа развития:яйцо, крошка, малыш и птенец. На каждом из этих этапов у Hatchimal появляются новые навыки: он учится ходить, говорить и танцевать.</p>
...
<div class='StepsOfThisShit'>
    <div class='content_1100'>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 noPad'>
                <h1>Этап 1. ЯЙЦО</h1>
                <div class='flex'>    
                    <div class='wrap_130'>
                        <img src='img/media_000000000104021002_3.png'>
                    </div>
                    <p class='addMarginForAdaptive'><span class='mus500 FS1em'>-Общается постукиванием.<br>
                        -Слышно биение сердца.<br>
                        -Переворачивается внутри.<br>
                        -Нужно согревать его в руках и заботиться.</span><br><br>
                        Чем больше Hatchimal получает внимания и любви, чем больше с ним играют, тем он активнее развивается(Наша игрушка является качественным фабричным аналогом, отличия от оригинала только тем что цена значительно ниже и яйцо нужно разбивать молоточком который в комплекте.)
                    </p>
                </div>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 noPad'>
                <h1>Этап 2. ВЫЛУПЛЕНИЕ</h1>
                <div class='flex'>
                    <div class='wrap_221'>
                        <img src='img/kisspng-hatchimals-toys-r-us-smyths-child-hatchimals-5b48aab108a2c2.7202568815314889450354.png'>
                    </div>
                    <p><span class='mus500 FS1em'>-Вылупляться ребёнку поможет молоточек(комплект).<br>
                            -Постукиванием  помоги птенцу появиться.<br>
                            -Помоги ему вылупиться.<br>
                            -Возьми в руки, погладь.</span><br><br>
                        Этот птенец будет любимцем не только у детей, он приковывает внимание даже взрослых: привлекательная внешность, веселые песенки, интересные движения и милое общение при помощи глаз!</p>
                </div>
            </div>
        </div>
    </div>
...
<div class='StepsOfThisShit_again'>
    <div class='content_1100'>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 noPad'>
                <h1>Этап 3. ПИТОМЕЦ</h1>
                <div class='flex'>    
                    <div class='wrap_215'>
                        <img src='img/dsadsaadsdsaasddas.png'>
                    </div>
                    <p><span class='mus500 FS1em'>-Чудесный плюшевый малыш.<br>
                        -Двигается и танцует.<br>
                        -Покорми его, когда он голоден.<br>
                        -Любит обниматься и нежиться.<br>
                        -Помоги ему расти и развиваться.<br>
                        -Играй с ним.</span><br><br>
                        На этапе «Птенец» Hatchimal может не только играть в совместные игры (что бы выиграть у Hatchimal нужно будет еще потренироваться!), но и даже предсказывать будущее! (Наша игрушка является фабричным аналогом, яйцо нужно разбивать молоточком который идёт в комплекте, наша игрушка практически ничем не отличается от оригинала, цена оригинала в магазинах от 6000р)
                    </p>
                </div>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 noPad'>
                <h1>Видеообзор игрушки Hatchimal</h1>
                <video controls="controls">
                    <source src="http://video.vdpl-cdn.com/f6d1691924cb328ae2720fd2dcdb60a01518599977.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>HATCHIMAL ТЕПЕРЬ В КАЗАХСТАНЕ!</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_hachmal order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
