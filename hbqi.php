...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Беспроводные наушники HBQ-i">
    <meta name="keywords" content="HBQ-i, Купить полезные товары, джентельменский набор">
...
<div class='purchase_block_HBQI'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>Беспроводные наушники HBQ-i</h1>
                <p class='gaySubsWhite'>Высочайшее качество передачи звука при низком энергопотреблении</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Беспроводные наушники HBQ-i"/>
                    <input type="hidden" name="price" value="9.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/hbqi.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_HBQI'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>9 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>30 000 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='adBlock_HBQI'>
        <div class='content_1100'>
            <div class='row margBot'>
                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_1'>
                        <img src='img/icdsadasadson.png'>
                   </div>
                   <p class='mar_9'>4 Ч ПРОСЛУШИВАНИЯ МУЗЫКИ/РАЗГОВОРА</p>
                </div>

                <div class='col-10 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_2'>
                        <img src='img/icondsaadsads5.png'>
                   </div>
                   <p class='mar_11'>СИНХРОНИЗАЦИЯ С ЛЮБЫМИ ГАДЖЕТАМИ</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_3'>
                        <img src='img/icodsaasddsn2.png'>
                   </div>
                   <p class='mar_12'>BLUETOOTH 4</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_4'>
                        <img src='img/iconsdsdsd8.png'>
                   </div>
                   <p class='mar_13'>РАДИУС ДЕЙСТВИЯ ДО 10 МЕТРОВ</p>
                </div>
            </div>

            <div class='row'>
                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_5'>
                        <img src='img/icosadadsadsn3.png'>
                   </div>
                   <p class='mar_14'>5-6 ДНЕЙ РАБОТЫ В РЕЖИМЕ ОЖИДАНИЯ</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_6'>
                        <img src='img/icsdsdsdsdon7.png'>
                   </div>
                   <p class='mar_15'>РАБОТАЮТ НА IOS И НА ANDROID</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_7'>
                        <img src='img/icosddssdsdn4.png'>
                   </div>
                   <p class='mar_16'>СИСТЕМА CVC ПОСЛЕДНЕГО ПОКОЛЕНИЯ</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 flexNoWrap vertAl'>
                   <div class='wrap_56 mar_8'>
                        <img src='img/icsdsdsdsdon6.png'>
                   </div>
                   <p class='mar_17'>УПРАВЛЕНИЕ ОДНИМ НАЖАТИЕМ</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class='content_1100'>
            ...
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 noPad'>
                    <div class='paramsContainer flex pt30'>
                        <p class='mus500 marLeft'>Тип:</p>
                        <p class='mus100 marRight'>Наушники/гарнитура для телефона</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Способ подключения:</p>
                        <p class='mus100 marRight'>Беспроводной (Bluetooth 4.2)</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Тип конструкции:</p>
                        <p class='mus100 marRight'>Вкладыши (TWS наушники)</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Тип акустического оформления:</p>
                        <p class='mus100 marRight'>Открытые</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Тип крепления:</p>
                        <p class='mus100 marRight'>Внутриушное</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Вес, г:</p>
                        <p class='mus100 marRight'>Каждый по 7 г</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Материалы:</p>
                        <p class='mus100 marRight'>Пластик/силикон</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Цвет:</p>
                        <p class='mus100 marRight'>Белый</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Питание:</p>
                        <p class='mus100 marRight'>Аккумулятор</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Время работы:</p>
                        <p class='mus100 marRight'>4 ч прослушивания музыки/разговора</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Apple-совместимость:</p>
                        <p class='mus100 marRight'>Есть</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Android-совместимость:</p>
                        <p class='mus100 marRight'>Есть</p>
                    </div>
                </div>
                ...
                <div class='col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 noPad'>
                    <div class='wrap_414'>
                        <img src='img/sdfsfdsfdsdfsdf.png'>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='techParams_HBQI'>
        <div class='content_1100'>
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 noPad'>
                    <div class='wrap_388'>
                        <img src='img/asdsdadsadsasd.png'>
                    </div>
                </div>
                <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 noPad'>
                    <h1>Аудио характеристики</h1>
                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Конструкция излучателя:</p>
                        <p class='mus100 marRight'>динамические</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Количество излучателей в 1 наушнике:</p>
                        <p class='mus100 marRight'>1</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Частотный диапазон, Гц:</p>
                        <p class='mus100 marRight'>20-20000</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Сопротивление, Ом:</p>
                        <p class='mus100 marRight'>18</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Чувствительность, дБ:</p>
                        <p class='mus100 marRight'>115</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>Активное шумоподавление:</p>
                        <p class='mus100 marRight'>есть</p>
                    </div>

                    <h1>Комплектация</h1>
                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>1. Наушники</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>2. Кабель для зарядки от USB</p>
                    </div>

                    <div class='paramsContainer flex'>
                        <p class='mus500 marLeft'>3. Инструкция</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class='BlockWithVideo'>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/kBXCtT89qlw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Беспроводные наушники HBQ-i</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_HBQI order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
