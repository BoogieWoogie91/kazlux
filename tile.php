...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Tile брелок">
    <meta name="keywords" content="Tile, Купить полезные товары, джентельменский набор">
    <meta name="author" content="Denis Yakunin">
    <title>Tile брелок</title>
    ...
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>Apple Tile брелок</h1>
                <p class='gaySubsWhite'>Вы больше никогда не потеряете свои ключи</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Tile брелок"/>
                    <input type="hidden" name="price" value="8.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/tile.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_Tile'>
...
<div class='WTFifThis_Canon grayBGSS'>
    <div class='content_1100'>
        <h1>УДОБНОЕ МОБИЛЬНОЕ ПРИЛОЖЕНИЕ</h1>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 advertisementCol advertisementCol_1 '>
                <div class='wrap_540'>
                    <img src='img/afsfsafasasfafs.png'>
                </div>
            </div>

            <div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-6 offset-xl-1 advertisementCol ToysAdCol'>
                <p>Для использования трекеров Tile нужно установить на смартфон или планшет одноименное приложение. Минимальные требования текущей версии Tile App к смартфону - Bluetooth 4.0, GPS и операционная система iOS не ниже 8.1 или Android начиная с 4.4.2.  Совместимость с Apple Watch гарантируется при их подключении к iPhone с версией iOS не ниже 8.2. Я тестировал Android-версию приложения.<br><br>Приложение, как и сами гаджеты, очень удобное, стильное и продуманное. Крупный шрифт, понятные иконки, анимация для отображения поиска и установки соединения, подсказки при первом использовании функций — в общем, радует глаз.</p>                
            </div>
        </div>
...
<div class='WTFifThis_Canon'>
    <div class='content_1100'>
        <h1>ПРИМЕНЕНИЕ</h1>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6  advertisementCol ToysAdCol noPad'>
                <p>Брелок Apple Tile можно использовать с любыми предметами<br>нуждающихся в поиске.</p>
                <div class='wrap_381'>
                    <img src='img/fsfsdsfdsfdsdf.png'>
                </div>                
            </div>

            <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 advertisementCol advertisementCol_1 '>
                <div class='wrap_540'>
                    <img src='img/sfdfsdfsddfs5.png'>
                </div>
            </div>
        </div>
    </div>
...
<div class='videoBlock_Tile'>
    <div class='wrap_816'>
        <iframe width="100%" height="459" src="https://www.youtube.com/embed/EIMp7iPCl6U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Apple Tile брелок трекер</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_Tile order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>8 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>19130 тенге</span></p>
          </div>
        </div>
      </div>
