...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="CВЕРХМОЩНЫЙ НАЛОБНЫЙ ФОНАРЬ BORUIT">
    <meta name="keywords" content="BORUIT, Купить полезные товары, джентельменский набор">
    <meta name="author" content="Denis Yakunin">
    <title>НАЛОБНЫЙ ФОНАРЬ BORUIT</title>
...
<div class='purchase_block_BOR'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>CВЕРХМОЩНЫЙ НАЛОБНЫЙ ФОНАРЬ BORUIT</h1>
                <p class='gaySubsWhite'>СО СКИДКОЙ 53%</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="НАЛОБНЫЙ ФОНАРЬ BORUIT"/>
                    <input type="hidden" name="price" value="9.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/boruit.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_BOR'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>9 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>21 065 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='adBlock_BOR'>
        <div class='content_1100'>
            <div class='row margBot'>
                <div class='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 noPad'>
                   <div class='wrap_539'>
                        <img src='img/characteristics__characteristic7_icon.png'>
                   </div>
                </div>

                <div class='col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6 noPad'>
                   <div class='wrap_525'>
                        <img src='img/characteristics__characteristic8_icon.png'>
                   </div>
                </div>
            </div>
        </div>
    ...
    <div class='videoBlock_BOR'>
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/Zry9bjD2KSc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div class='WTFifThis_BOR'>
    <div class='content_1100'>
        <h1>ОПИСАНИЕ НАЛОБНОГО ФОНАРЯ BORUIT</h1>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 advertisementCol advertisementCol_1 '>
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators iphoneIndicators">
                  <li data-target="#carouselExampleIndicators" data-slide-to="0" class="red BORIndicator"><img src='img/sfdfdsfdssfd.png'></li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="1" class='pink BORIndicator'><img src='img/dsadsadsadassad.png'></li>
                  <li data-target="#carouselExampleIndicators" data-slide-to="2" class='blue BORIndicator'><img src='img/dsfdfsfsddfssdffsd.png'></li>
                </ol>
                <div class="carousel-inner">
                  <div class="carousel-item iphoneItem active">
                    <img class="d-block w-100" src="img/afsafsafsafs.png" alt="First slide">
                  </div>
                  <div class="carousel-item iphoneItem">
                    <img class="d-block w-100" src="img/afsafsafsafs.png" alt="Second slide">
                  </div>
                  <div class="carousel-item iphoneItem">
                    <img class="d-block w-100" src="img/afsafsafsafs.png" alt="Third slide">
                  </div>
                </div>
              </div>
            </div>

            <div class='col-12  col-sm-12  col-md-12  col-lg-6 offset-lg-1 col-xl-6 offset-xl-1  advertisementCol ToysAdCol noPad'>
                <p><b>Фонарь Boruit - это легкая и компактная налобная модель, ориентированная практически на любые виды туризма. В том числе, его используют альпинисты, спелеологи, любители отдыха в кемпинге, а также рыбаки и охотники.</b><br><br>Фонари иногда нужны даже дома, а в путешествии они часто становятся залогом безопасности. Даже если вы отправляетесь на пикник и планируете вернуться до темноты, фонарь, не занимая много места в рюкзаке, поможет вам чувствовать себя спокойнее. Фонарь сделан очень прочным, а помимо того, защищенным от пыли и воды. Он может эффективно работать под дождем или сильными брызгами, что особенно важно для туристов. Размер наголовного ремешка-крепления также регулируется в индивидуальном порядке.</p>
            </div>
        </div>
    </div>
</div>
...
<div class='noRivals BORRivals'>
    <div class='content_1100'>
        <h1>ПРИ ПОКУПКЕ ФОНАРЯ BORUIT ТРИММЕР<br>MICRO TOUCH MAX В ПОДАРОК!</h1>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair mashaNoRivalsCol_1 noPad'>        
        <ul class='noRivalsList spotcleanRL'>
          <li>
            ...
            <p>Удаляет волосы в носу, ушах</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tickwhite.png'>
            </div>
            <p>Не вызывает раздражения</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tickwhite.png'>
            </div>
            <p>Безопаснее бритвы и ножниц</p>
          </li>
        </ul>
      </div>

        <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol BORNoRivalsCol_2'>
...
<div class='picBlockBOR'>
    <div class='content_1100'>
        <h1>ПРИМЕНЕНИЕ ФОНАРЯ BORUIT</h1>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-6  col-lg-3  col-xl-3'>
                <div class='wrap_180'>
                    <img src='img/use__use1_image.png'>
                </div>
                <p>ДЛЯ РЫБАЛКИ, ОХОТЫ, ВЫЕЗДОВ НА ПРИРОДУ</p>
            </div>

            <div class='col-12  col-sm-12  col-md-6  col-lg-3  col-xl-3'>
                <div class='wrap_180'>
                    <img src='img/use__use2_image.png'>
                </div>
                <p>ДЛЯ ТУРИЗМА, ПРОГУЛОК, ПОХОДОВ</p>
            </div>

            <div class='col-12  col-sm-12  col-md-6  col-lg-3  col-xl-3'>
                <div class='wrap_180'>
                    <img src='img/use__use3_image.png'>
                </div>
            ...
            <div class='col-12  col-sm-12  col-md-6  col-lg-3  col-xl-3'>
                <div class='wrap_180'>
                    <img src='img/use__use4_image.png'>
                </div>
                <p>ДЛЯ ЛЮБЫХ БЫТОВЫХ НУЖД</p>
            </div>
        </div>
        <div class='blockForButton'>
            <div class='buttonWrap_1'>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>CВЕРХМОЩНЫЙ НАЛОБНЫЙ ФОНАРЬ BORUIT</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_BOR order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
