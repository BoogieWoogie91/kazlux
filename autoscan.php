...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Автосканер ELM327">
    <meta name="keywords" content="Автосканер ELM327, Купить полезные товары, джентельменский набор">
    <meta name="author" content="Denis Yakunin">
    <title>Автосканер ELM327</title>
...
<div class='purchase_block_AS'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class=''>Автосканер ELM327</h1>
                <p class='gaySubs'>(bluetooth, версия 1.5)</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Автосканер ELM327"/>
                    <input type="hidden" name="price" value="8.990"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/autoscan.html"/>
                    <p style="color:#fff;">Ваше Имя</p>
                    <input class='purchaseFormInput' type="text" placeholder="Имя" name='name'>
                    <p style="color:#fff;">Ваш Телефон</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_AS'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>8 990тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>19 130 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='adBlock_AS'>
        <div class='content_1100'>
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 flexNoWrap vertAl noPad'>
                   <div class='wrap_56 marr_1'>
                        <img src='img/f-img3.png'>
                   </div>
                   <p class='margTop'><span class="mus700 q1rem">Ударопрочность</span><br></p>
                </div>

                <div class='col-10 col-sm-12 col-md-6 col-lg-4 col-xl-4 flexNoWrap vertAl noPad'>
                   <div class='wrap_56 marr_2'>
                        <img src='img/f-img2.png'>
                   </div>
                   <p class='margTop'><span class="mus700 q1rem">Качество продукции</span><br></p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 flexNoWrap vertAl noPad'>
                   <div class='wrap_56 marr_3'>
                        <img src='img/f-img1.png'>
                   </div>
                   <p class='margTop'><span class="mus700 q1rem">Простота использования</span><br></p>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class='content_1100'>
    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-7'>
        <h1>Автосканер ELM327 (bluetooth)</h1>
        <p class='blackpp'>Диагностические адаптеры OBD-2, произведенные на базе микроконтроллера ELM327 самой последней версии 1.5 отлично показали себя благодаря своему качеству и надежности.<br><br>Программы для работы с адаптером ELM327 bluetooth обладают большим функционалом, возможностями, современным внешним видом и поддержкой мультиязычности, среди них имеются программы, обладающие даже многими дилерскими функциями!<br><br>Благодаря данному автосканеру, Вы всегда будете знать, что с Вашей машиной и в каком она состоянии. Получайте самые точные данные в реальном времени!</p>
      </div>

      <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 margincolumn fastHairColumn_1 fastHair_Col_again'>
        <img src='img/sadadsdassadsad.png'>
      </div>
    </div>

    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 margincolumn fastHairColumn_1 fastHair_Col_again'>
        <img src='img/asfsafafsasf.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-7'>
        <p class='blackpp'>Среди всех OBDII-автосканеров ELM327 bluetooth без сомнения является самым быстрым по части установления соединения с блоком управления(ЭБУ, ECU) машины. Там, где прочие сканеры могут отказать в работе, ELM327 отлично справится со своими задачами.<br><br>Теперь все возможности этого удобного устройства доступны и вам: достаточно всего лишь купить адаптер ELM327 bluetooth Сэкономьте время и деньги на поездках в сервисный центр, с помощью Elm 327 Вы сможете сами узнать что именно не в порядке.</p>
      </div>
    </div>
  </div>
</div>
...
<div class='blockForButton'>
    <div class='buttonWrap_1'>
        <a href="#form"><div class="buttonChanger">Купить и получить подарок</div></a>
    </div>   
</div>


<div class='carBlock pr'>
    <div class='content_1100'>
        <div class='row'>
            <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 fastHairColumn_1 pt'>
                <div class='wrap_528'><img src='img/a-img.png'></div>
            </div>

            <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6'>
                <div class='flexNoWrap'>
                    <div class='wrap_56 marr_1'>
                        <img src='img/a-img1.png'>
                   </div>
                   <p class='m1'><span class="q1rem">Чтение и расшифровка кодов неисправностей, благодаря чему Вы сможете сразу понять и разобраться в чём именно возникла неисправность на Вашей машине;</span><br></p>
                </div>

                <div class='flexNoWrap'>
                    <div class='wrap_56 marr_1'>
                        <img src='img/a-img2.png'>
                   </div>
                   <p class='m2'><span class="q1rem">Удаление ошибок из памяти блока управления автомобиля(ЭБУ) с целью погасить лампу Check Engine, без вмешаний специалистов сервисного центра;</span><br></p>
                </div>

                <div class='flexNoWrap'>
                    <div class='wrap_56 marr_1'>
                        <img src='img/a-img3.png'>
                   </div>
                   <p class='m3'><span class="q1rem">Чтение параметров работы ДВС в реальном времени, контролируйте всё происходящее именно сейчас;</span><br></p>
                </div>

                <div class='flexNoWrap'>
                    <div class='wrap_56 marr_1'>
                        <img src='img/a-img4.png'>
                   </div>
                   <p class='m4'><span class="q1rem">Отображать текущие (LIVE DATA) значения различных датчиков.</span><br></p>
                </div>
            </div>
        </div>
    </div>
...
<div class='qualities noPadQualit grayBG'>
  <div class='content_1100'>
    <h1>Автосканер ELM327 (bluetooth)</h1>
    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-5  col-xl-5 margincolumn fastHairColumn_1 fastHair_Col_again'>
        <div class='wrap_360'><img src='img/info-img1.png'></div>
        <div class='wrap_288'><img src='img/info-img2.png'></div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-7  col-xl-7'>
        <p class='blackpp'><b>Через Elm327 bluetooth можно контролировать такие параметры работы двигателя, как:</b><br> 
                        - Обороты двигателя, расчетная нагрузка на двигатель;<br> 
                        - Мощность двигателя текущая/максимальная за поездку, кВт или л/с;<br> 
                        - Крутящий момент, напряжение бортовой сети;<br> 
                        - Температура охлаждающей жидкости, давление во впускном коллекторе;<br> 
                        - Массовый расход воздуха (MAF), скорость движения автомобиля;<br> 
                        - Расчет времени разгона 0-100 км/ч, расчет времени торможения 110-0 км/ч;<br> 
                        - Соотношение кислород/топливо, температура окружающего воздуха;<br> 
                        и иные параметры, поддерживаемые ЭБУ автомобиля.<br><br>

                        <b>Поддерживаемые протоколы OBD-II:</b><br> 
                        - SAE J1850 PWM;<br> 
                        - SAE J1850 VPW;<br> 
                        - ISO 9141-2;<br> 
                        - ISO 14230 KWP2000;<br> 
                        - ISO 15765 CAN.<br><br>  

                        <b>Комплект поставки:</b><br> 
                        - Адаптер.<br>

                        Многофункциональный автосканер ELM327 bluetooth может работать со смартфонами на Symbian , ОС Blackberry , Windows Mobile, Android OS , Palm OS и другими устройствами, имеющими интерфейс bluetooth.<br><br>

                        Большую популярность сканер ELM327 bluetooth получил из-за своей многофункциональности и работе со всеми протоколами OBDII - ISO 9141, KWP2000, SAE J1850PWM и VPM. Так же огромное преимущество - поддержка CAN шины, которой сейчас оборудуется каждый новый автомобиль.
                        </p>
      </div>      
    </div>
  </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Автосканер ELM327</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_AS order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
