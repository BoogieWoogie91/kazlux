...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="МУЖСКИЕ ЧАСЫ DIESEL 10 BAR">
    <meta name="keywords" content="DIESEL 10 BAR, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Diesel 10 bar</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/dieselslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/dieselslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/dieselslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/dieselslider1.png" alt="carouselimg">
    </div>
...
<div class='orderThisNow'>
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>МУЖСКИЕ ЧАСЫ DIESEL 10 BAR</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 DieselOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>МУЖСКИЕ ЧАСЫ DIESEL 10 BAR</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="dieselWatch"/>
            <input type="hidden" name="price" value="15.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/diesel_10bar.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_diesel order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>15 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>53 000 тенге</span></p>
          </div>
        </div>
      </div>
  ...
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Diesel 10 BAR – это классическая модель часов, идеально подходящая мужчинам с сильным 
                        характером и пунктуальностью.
                        Модель отличается аккуратным и нежным внешним видом, 
                        благодаря корпусу из нержавеющего металла и нежно-синего напыления.!</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Diesel 10 bar"</li>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/dieselgal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/dieselgal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='purchase_block_diesel'>
    <div class='content_1100'>
                <h1>МУЖСКИЕ ЧАСЫ DIESEL 10 BAR</h1>
        <div class='row purchaseRow'>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_diesel'>
                <div>
                ...
                <div class='insidePicCol_tag36'>
                    <img class='showableImg' src="img/dieselimg.png">
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/_cVZUbgmOu0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
