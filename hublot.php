...
<html lang="ru">
  <head>
    ...
    <meta name="keywords" content="Hublot, Элитные часы, Подарок часы, Купить элитные часы">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/hublot_1.jpg">
    </div>
    <div>
      <img src="img/hublot_2.jpg">
    </div>
    <div>
      <img src="img/hublot_3.jpg">
    </div>
    <div>
      <img src="img/hublot_1.jpg">
    </div>
...
<div class='orderThisNow'>
  <div class='content_1366'>
    ...
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 HublotOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        ...
        <p class='alignstart showable2'>+ ЧАСЫ TISSOT В ПОДАРОК</p>
          <div class='form_lastBlock'>
            ...
            <input type="hidden" name="tema" value="hublot_landing"/>
            <input type="hidden" name="price" value="8.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/hublot.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_hublot order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1_hublot'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>8 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>17 800 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='gallery hublotGal'>
  <div class='content_1100_1'>
    <div class='row galleryRow hublot_gallery'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_22'>
          <img src='img/layer_37.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_24'>
          <img src='img/layer_38.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='goodGift_hublot'>
  <div class='row goodGiftRow'>
    <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 goodGiftCol goodGiftCol_1_hublot'>
      <div class='wrapper_1'>
      <h1>Часы Tissot</h1>
      <h1 class='yellow'>Отличный подарок</h1>
      <div class='charLists_hublot'>
        <ul>
          <li><span class='boldy'>Механизм:</span> Кварцевый</li>
          <li><span class='boldy'>Сборка:</span> Бельгия</li>
          <li class='last'><span class='boldy'>Корпус:</span> Металлический</li>         
        </ul>
        <ul class='rightUl_hublot'>          
          <li><span class='boldy'>Влагозащита:</span> WR-30</li>
          <li><span class='boldy'>Ремешок:</span> Кожа</li>
          <li class='last'><span class='boldy'>Длина Ремешка:</span> 24см</li>
        </ul>
      </div>
    </div>
    </div>
    <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-5 offset-xl-1 goodGiftCol goodGiftCol_2_hublot'>
      <div class='imgWrap_25'>
        <img src='img/layer_39.png'>
      </div>
      <div class='buttonWrap_4'>
...
<div class='trueFeedbackBlock'>
  ...
  <div class='purchase_block_hublot'>
  <div class='content_1100'>
  <div class='row purchaseRow'>
    ...
    <div class='col-12 col-sm-12 offset-sm-0 col-md-10 offset-md-1 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_hublot'>
      <h1>ЛЕГЕНДАРНЫЕ ЧАСЫ HUBLOT</h1>
      <p>+ ЧАСЫ TISSOT В ПОДАРОК</p>
      <div class='insidePicColHublot'>
        <div class='description_hublot'>
          ...
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price hublPrice'>8 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>17 800 тенге</span></p>
          </div>
        </div>
      </div>
