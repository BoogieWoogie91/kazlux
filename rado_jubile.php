...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Rado jubile">
    <meta name="keywords" content="Rado jubile, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Rado jubile</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/jubileslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/jubileslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/jubileslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/jubileslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>RADO "Jubile True" ЛЕГЕНДАРНЫЕ ЧАСЫ</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 JubileOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>RADO "Jubile True" ЛЕГЕНДАРНЫЕ ЧАСЫ</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Rado Jubile"/>
            <input type="hidden" name="price" value="17.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/rado_jubile.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_radoJubile order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>17 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>35 980 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Отличительной чертой часов RADO "Jubile True" является особенная, лишенная вызывающего гламура, роскошь, сдержанная и элегантная. Rado "Jubile True" – это современный и эстетичный взгляд на классический круглый циферблат часов! </p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "RADO"</li>
          <li><span class='boldy'>Браслет:</span> 440-ая нержавеющая сталь</li>
        ...
        <ul class='rightUl'>
          ...
          <li class='last'><span class='boldy'>Цвет Корпуса:</span> Черный, белый</li>
        </ul>
      </div>
      </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/jubilegal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/jubilegal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='purchase_block_jubile'>
    <div class='content_1100'>
                <h1>RADO "Jubile True" ЛЕГЕНДАРНЫЕ ЧАСЫ</h1>
        <div class='row purchaseRow'>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_jubile'>
                <div>
                ...
                <div class='insidePicCol_jubile'>
                    <img src="img/526633575_w0_h0_true5.png">
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/wNPfqHRp7Bs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
