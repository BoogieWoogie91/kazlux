...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="RADO INTEGRAL">
    <meta name="keywords" content="Rado Integral, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Rado Integral</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/gssdggsdsdg.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/asfafsafsfasfsa.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/sdgsdgsgdgds.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/gssdggsdsdg.png" alt="carouselimg">
    </div>
...
<div class='orderThisNow' id='orderThisNow'>
  <div class='content_1366'>
  	<div class='row wrapper_10Row'>
  		<div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
  			<h1 class='alignLeftt hidable2'>RADO INTEGRAL</h1>
  			<p class='alignLeftt hidable2'>РАСПРОДАЖА ЭЛИТНЫХ ЧАСОВ</p>
  		</div>
  	</div>
  	<div class='row orderThisNowRow align-items-start'>
  		<div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 RadoOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>RADO INTEGRAL</h1>
        <p class='alignstart showable2'>РАСПРОДАЖА ЭЛИТНЫХ ЧАСОВ</p>
  				<div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Rado Integral"/>
            <input type="hidden" name="price" value="17.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/rado_integral.html"/>
            <p>Ваше Имя</p>
  		...
  		<div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_rado order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
  			<div class='priceCircle_1'>
  				<div class='innerPriceCircle_1'>
  					<p>Цена со скидкой</p>
  					<p class='price'>17 990тг.</p>
  					<p>Старая цена:<br><span class='lineThrough'>59 670 тенге</span></p>
  				</div>
  			</div>
  		</div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>В современном мире классические аксессуары имеют особую ценность.<br>Они содержат в себе определенный культурный код, который считывают люди одного с вами круга.<br>Отражением этой концепции являются часы Rado Integral.<br>Узнаваемая модель символизирует сдержанную роскошь, не нуждающуюся в демонстрации.<br>Безупречный стиль и великолепный дизайн выделяют этот хронометр из сотен обычных изделий.<br>Он наверняка станет вашим фаворитом и придаст вам веса в компании<br>старых друзей, на переговорах с партнерами или на вечеринке.</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Rado"</li>
        ...
        <ul class='rightUl'>
          ...
          <li><span class='boldy'>Браслет:</span> 440-ая нержавеющая сталь, керамика</li>
          <li class='last'><span class='boldy'>Вес:</span> 88гр</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/layer_32.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='moreAdChar'>
	<div class='content_1100'>
		<div class='row moreAdCharRow'>
			<div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 moreAdCharCol moreAdCharCol_1'>
				<div class='imgWrap_14'>
					<img src='img/clock.png'>
				</div>
				<h5>ТОЧНОСТЬ ХОДА</h5>
				<p>Японский механизм: Miyota калибр 256041.0, сборка Тайвань</p>
			</div>
			<div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 moreAdCharCol moreAdCharCol_2'>
				<div class='imgWrap_15'>
					<img src='img/flower.png'>
				</div>
				<h5>СТИЛЬНЫЙ ДИЗАЙН</h5>
				<p>Аксессуар, который выделяет Ваш стиль и высокий статус</p>
			</div>
			<div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 moreAdCharCol moreAdCharCol_3'>
				<div class='imgWrap_16'>
					<img src='img/gears.png'>
				</div>
				<h5>СОВРЕМЕННЫЕ МАТЕРИАЛЫ</h5>
				<p>440-ая нержавеющая сталь, износостойкая Керамика HI-TECH</p>
			</div>
			<div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 moreAdCharCol moreAdCharCol_4'>
				<div class='imgWrap_17'>
					<img src='img/umbrella.png'>
				</div>
				<h5>ВОДОНЕПРОНИЦАЕМОСТЬ</h5>
				<p>Водоустойчивые - 3 АТМ (влага и брызги)</p>
			</div>
		</div>
	</div>
</div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/layer_34.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/layer_33.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='supposedToMakeUbuy'>
    ...
    <div class='buttonWrap_1'>
      <a href="#orderThisNow"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
    </div>
  </div>
</div>
...
<div class='purchase_block_rado' id="purchaseBlock">
  <div class='content_1100'>
  <div class='row purchaseRow'>
    <div class='col-12 offset-0 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-0 col-xl-4 formCol'>
      <div class='form'>
        <form action="form/integration.php" method="post">
        <input type="hidden" name="tema" value="rado_integral"/>
        <input type="hidden" name="price" value="17.900"/>
        <input type="hidden" name="comments" value="http://kz-luxury.com/rado_integral.html"/>
        <p>Ваше ФИО</p>
        <input class='purchaseFormInput' type="text" name='name' placeholder="Иван Иванович">
        <p>Ваш Телефон</p>
    ...
    <div class='col-12 col-sm-12 offset-sm-0 col-md-10 offset-md-1 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_rado'>
      <h1>RADO INTEGRAL</h1>
      <p>РАСПРОДАЖА ЭЛИТНЫХ ЧАСОВ</p>
      <div class='priceCircle_1'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price hublPrice'>17 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>59 670 тенге</span></p>
          </div>
        </div>
    </div>
        ...
        <div class='content_1230'>
            <div class='row'>
                ...
                <div class='col-6 col-sm-6 col-md-8 col-lg-8 col-xl-8'>
                    <p>ООО "Название компании" 050028, Павлодар, ул. Майры, д.49</p>
                </div>
                <div class='col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1'>
                    <button><a href="#purchaseBlock"><img src="img/arrow-up.png"></a></button>
                </div>
            </div>
        </div>
    </div>
				  ...
				  <div class="modal-dialog modal-dialog-centered" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				      	<iframe width="1000" height="600" src="https://www.youtube.com/embed/kRHfrrTNSZ8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				      </div>
				    </div>
				  </div>
				</div>
