...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="SPLIT ENDER">
    <meta name="keywords" content="SPLIT ENDER, Товары для красоты, Товары для здоровья">
    <meta name="author" content="Denis Yakunin">
    <title>Split Ender</title>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>SPLIT ENDER</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 spliEndOrderCol order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Hot Shapers"/>
            <input type="hidden" name="price" value="6.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/splitender.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_SE order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>6 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>14 685 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='reviews'>
    <div class='content_1100'>
        <h1 class='xtrimh1 addmargbot'>Видео обзоры SPLIT ENDER</h1>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 SEiFrames'>
                <iframe width="320" height="204" src="https://www.youtube.com/embed/JC6F1aNysic" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 SEiFrames'>
                <iframe width="320" height="204" src="https://www.youtube.com/embed/VWJLn2qM2F8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 SEiFrames'>
                <iframe width="320" height="204" src="https://www.youtube.com/embed/GeOuDrOTfAk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair'>
        <h1>Эффективность Split Ender</h1>
        ...
        <ul class='noRivalsList'>
          ...
          <li>
            ...
            <p>100% Безопасный для ваших волос. Гарантия качества</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Товар сертифицирован. Производство США</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Быстрая доставка по всему СНГ от 1 до 10 дней. 
          ...
          <li>
            ...
            <p>Не понравился товар - мы вернём вам деньги</p>
          </li>
        </ul>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol SENoRivalsCol_2'>
  ...
  <div class='content_1100'>
    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 fastHairQualitiesText'>
        <p class='blackpp'>Благодаря этому чудесному изобретению, Вы можете достичь желаемой длинны волос быстрее, а длинные волосы сохранить более красивыми и здоровыми, чем раньше!<br><br>Применение технологии "STSTM" гарантирует, что все концы волос будут аккуратно подрезаны (в среднем на 3-6 мм), при эомт длина волос практически сохранится</p>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 margincolumn fastHairColumn_1 fastHair_Col_again'>
        <img src='img/afsafsafsa.png'>
      </div>
    </div>
  </div>
</div>
...
<div class='purchase_block_SE'>
    <div class='content_1100'>
                <h1>SPLIT ENDER</h1>
                <p class='gaySubsBlack'>Воплоти свою мечту о роскощных и гладких волосах в реальность!</p>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                        <input type="hidden" name="tema" value="Split Ender"/>
                        <input type="hidden" name="price" value="6.900"/>
                        <input type="hidden" name="comments" value="http://kz-luxury.com/splitend.html"/>
                        <p>Ваше ФИО</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                ...
                <div class='insidePicCol_SE'>
                    <img src="img/shop_items_catalog_image_3536.png">
                </div>
            </div>
            </div>
        </div>
