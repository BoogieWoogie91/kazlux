...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Smartwatch007">
    <meta name="keywords" content="Smartwatch007, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Smartwatch007</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/smartwatchslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/smartwatchlider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/smartwatchslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/smartwatchslider1.png" alt="carouselimg">
    </div>
...
<div class='orderThisNow'>
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>Smart Watch SW007</h1>
        <p class='alignLeftt hidable2'>Инновационные Умные часы с широчайшими возможностями</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 S007OrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Smart Watch SW007</h1>
        <p class='alignstart showable2'>Инновационные Умные часы с широчайшими возможностями</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="smartwatch007"/>
            <input type="hidden" name="price" value="19.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/smartwatch007.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_smartwatch007 order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>19 990тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>39 800 тенге</span></p>
          </div>
        </div>
      </div>
  ...
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Современные технологии позволяют создавать оригинальные умные часы Smart Watch SW007. 
                        Оригинальная модель таких часов оснащается фитнес-функциями, камерой и функцией 
                        поддержки сим-карты, легко синхронизируется с гаджетами на операционной системе Android.</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "SW007 Smart Watch"</li>
          <li><span class='boldy'>Экран:</span> TFT 1.22 240*240</li>
          <li class='last'><span class='boldy'>Камера:</span> 1,3mpx</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> Сталь PU</li>
          <li><span class='boldy'>Браслет:</span> Каучук</li>
          <li class='last'><span class='boldy'>Диаметр циферблата:</span> 5,6*4,8*1,5 см</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/xdf25-8.png.pagespeed.ic.K90bXm_rvD8.png'>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/007gal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/007gal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='allFunctionsOfThisShit'>
  <div class='content_1100'>
    <div class='row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 functionsCol'>
        <div class='wrapThisShitUp'><img src='img/coloredshit1.png'></div>
      </div>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 functionsCol'>
        <div class='wrapThisShitUp'><img src='img/coloredshit2.png'></div>
      </div>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 functionsCol'>
        <div class='wrapThisShitUp'><img src='img/coloredshit3.png'></div>
      </div>
    </div>
  </div>
</div>
...
<div class='purchase_block_007watch'>
  <div class='content_1100'>
    <h1>Smart Watch SW007</h1>
  <div class='row purchaseRow'>
    <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-6 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
      <div class='form'>
        <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="smartwatch007"/>
            <input type="hidden" name="price" value="19.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/smartwatch007.html"/>
        <p>Ваше ФИО</p>
    ...
    <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-6 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_007watch'>
        <div class='priceCircle_1_tag_1'>
            <div class='innerPriceCircle_1'>
                <p>Цена со скидкой</p>
                <p class='price'>19 900тг.</p>
                <p>Старая цена:<br><span class='lineThrough'>39 800 тенге</span></p>
            </div>
        </div>
      <div class='insidePicCol'>
        <img src='img/SW007111.png'>
     </div>
    </div>
  </div>
  </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/gFxekIap-sA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
