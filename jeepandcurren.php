...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="КОЖАНАЯ МУЖСКАЯ СУМКА JEEP">
    <meta name="keywords" content="JEEP, Качественная сумка, Подарок сумка, Купить сумку">
    <meta name="author" content="Denis Yakunin">
    <title>Jeep + Curren</title>
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider s7sliders" id="slider">
    <div>
      <img src="img/ffsasdfsdffdssdf8.png">
    </div>
    <div>
      <img src="img/fsdfsdsfdsdffsdsfdasdfagsd6.png">
    </div>
    <div>
      <img src="img/sdffsdsfdsdgsddhfs7.png">
    </div>
    <div>
      <img src="img/ffsasdfsdffdssdf8.png">
    </div>
...
<div class='bagFormBlock'>
  <div class='content_1100'>
    <h1 class='mostPopular'>КОЖАНАЯ МУЖСКАЯ СУМКА JEEP</h1>
    <p class='mostPopularSub'>+ ЧАСЫ CURREN В ПОДАРОК</p>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4'>
        <div class='bagPriceCircle'>
          <div class='bagPriceInner'>
            <p>Цена со скидкой</p>
            <h5>10 900тг</h5>
            <p>Cтарая цена<br><span class='lineThrough'>36 335 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-4  col-xl-4 orderThisNowCol_1'>
        <div class='form_lastBlock'>
          <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Jeep and Curren"/>
            <input type="hidden" name="price" value="10.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/jeepandcurren.html"/>
            <p>Ваше Имя</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='manufacturer5'><span class='boldy'>Цвет:</span> Черный, темно-коричневый, светло-коричневый</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/resolution.png'>
              </div>
              <p class='manufacturer6'><span class='boldy'>Размеры:</span> 38 X 18 X 4.5 СМ</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/briefcase.png'>
              </div>
              <p><span class='boldy'>Тип:</span> Мужская сумка на ремне</p>
            </li>
            <li>
              <div class='imgWrapper'>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='moreMargin'><span class='boldy'>Особенности:</span> 5 отсеков на молнии, 1 внутренний карман, отверстие для наушников</p>
            </li>
            <li>
              <div class='imgWrapper_1'>
                <img src='img/zip.png'>
              </div>
              <p class='manufacturer8'><span class='boldy'>Материал:</span>Натуральная кожа</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/food-scale-tool.png'>
              </div>
              <p class='manufacturer9'><span class='boldy'>Вес:</span> 450г</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/3d-modeling.png'>
              </div>
              <p class='manufacturer10'><span class='boldy'>Модель:</span> JEEP 19-41</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/guerro-1.png'>
          </div>
        </div>
      </div>
    </div>
...
<div class='whyBuyThisShit'>
  <div class='content_1100'>
    <h1>ПОЧЕМУ JEEP?</h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-1.png'>
        </div>
        <h5>НЕПРЕВЗОЙДЕННОЕ КАЧЕСТВО</h5>
        <p>Каждый экземпляр проходит 
          тщательный контроль качества</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-2.png'>
        </div>
        <h5>ПРАКТИЧНОСТЬ И УДОБСТВО</h5>
        <p>Сумка вместительна, приятна на
          ощупь и комфортна в носке</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-3.png'>
        </div>
        <h5>ИЗВЕСТНЫЙ БРЕНД JEEP</h5>
        <p>Каждый экземпляр проходит 
          тщательный контроль качества</p>
      </div>
    </div>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_1'>
          <ul class='paramsList'>
            <li>
              ...
              <p class='manufacturer'><span class='boldy'>Производитель:</span> Бельгия</p>
            </li>
            <li>
            ...
            <li>
              ...
              <p class='manufacturer2'><span class='boldy'>Корпус:</span> Часовая сталь</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 techParamsCol techParamsCol_2'>
          <ul class='paramsList'>
            ...
            <li>
              ...
              <p class='manufacturer3'><span class='boldy'>Ремешок:</span>Кожанный с фирменной застежкой</p>
            </li>
            <li>
              <div class='imgWrapper'>
                <img src='img/stopwatch.png'>
              </div>
              <p class='manufacturer4'><span class='boldy'>Функции:</span> Часы, минуты, секунды</p>
            </li>
          </ul>
        </div>
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/amst-2.png'>
          </div>
        </div>
      </div>
    </div>
...
<div class='whyBuyThisShit'>
  <div class='content_1100'>
    <h1>CURREN - МУЖСКИЕ ЧАСЫ №1!</h1>
    <div class='row'>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-5.png'>
        </div>
        <h5>КАЧЕСТВЕННЫЙ РЕМЕШОК</h5>
        <p>Не деформируется при ношении 
          и прослужит вам долгое время</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-4.png'>
        </div>
        <h5>НАДЕЖНОЕ СТЕКЛО</h5>
        <p>Сапфировое с антибликовым покрытием 
          устойчиво к сколам и царапинам</p>
      </div>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4'>
        <div class='imgWrapForBags'>
          <img src='img/sup-6.png'>
        </div>
        <h5>УНИВЕРСАЛЬНЫЙ ВНЕШНИЙ ВИД</h5>
        <p>Подойдут одинаково как под 
          классику, так и под стиль casual</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи мужскую сумку JEEP</h1>
        <p class='alignLeftt hidable2'>+ ЧАСЫ CURREN В ПОДАРОК</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 JeepOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи мужскую сумку JEEP</h1>
        <p class='alignstart showable2'>+ ЧАСЫ CURREN В ПОДАРОК</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Jeep + Curren"/>
            <input type="hidden" name="price" value="10.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/jeepandcurren.html"/>
            <p>Ваше Имя</p>
            <input class='purchaseFormInput' type="text" placeholder="Имя" name='name'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_jeep order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>10 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>36 335 тенге</span></p>
          </div>
        </div>
      </div>
