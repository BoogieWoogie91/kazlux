...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Элитные женские часы Baosaili">
    <meta name="keywords" content="Baosaili, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Baosaili</title>
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/baoslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/baoslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/baoslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/baoslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>Элитные женские часы Baosaili </h1>
        <p class='alignstart hidable2'>+ БРАСЛЕТ PANDORA В ПОДАРОК!</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 BaoOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Элитные женские часы Baosaili </h1>
        <p class='alignstart showable2'>+ БРАСЛЕТ PANDORA В ПОДАРОК!</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Baosaili"/>
            <input type="hidden" name="price" value="10.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/baosaili.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_bao order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>10 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>23 195 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Baosaili международный бренд, известный во всем мире! 
                        Эксклюзивный дизайн данных часов значительно выделяется из всей линейки бренда. 
                        Ремешок сделан из гипоаллергенных материалов, которые не раздражают кожу на запястье. .</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "Baosaili"</li>
          <li><span class='boldy'>Браслет:</span> Нержавеющий сплав</li>
          <li class='last'><span class='boldy'>Стекло:</span> Минеральное</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> Износостойкий сплав</li>
          <li><span class='boldy'>Механизм:</span> Кварцевые</li>
          <li class='last'><span class='boldy'>Диаметр циферблата:</span> 32мм</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/sec1-right.png'>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/baogal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/baogal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='trueFeedbackBlock'>
  ...
  <div class='purchase_block_bao'>
    <div class='content_1100'>
                <h1>Элитные женские часы Baosaili</h1>
        <div class='row purchaseRow'>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_bao'>
                <div>
