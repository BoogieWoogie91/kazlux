...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Закажи свой IPhone X">
    <meta name="keywords" content="Iphone X, Купить телефон, Подарок близким,  Точная копия">
...
<!---------------------------------------------------------------------EBANNYI SLICK-->
  <section class="center slider iphoneSliders" id="slider">
    ...
    <div>
      <img src="img/iphonex2.jpg">
    </div>
    <div>
      <img src="img/iphonex3.jpg">
    </div>
    <div>
      <img src="img/iphonex1.jpg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-2'>
        <h1 class='alignLeftt hidable2'>Закажи свой IPhone X</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 IPhoneXOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class='alignLeftt showable2'>Закажи свой IPhone X</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="IPhonex"/>
            <input type="hidden" name="price" value="34.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/iphonex.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_iPhoneX order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>34 900тг.</p>
...
<div class='advertisement'>
    <div class='content_1100'>
        ...
        <p class='mostPopularSub'>Apple iPhone X – полная реплика оригинала</p>
        ...
        <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 advertisementCol advertisementCol_1 '>
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators iphoneIndicators">
              ...
              <li data-target="#carouselExampleIndicators" data-slide-to="1" class='grayIndicator'></li>
            </ol>
            <div class="carousel-inner iPhone7">
              <div class="carousel-item iphoneItem active">
                <img class="d-block w-100" src="img/30030163b.png" alt="First slide">
              </div>
              <div class="carousel-item iphoneItem">
                <img class="d-block w-100" src="img/30030164b.png" alt="Second slide">
              </div>
            </div>
          </div>
          <p>Выберите Цвет</p>          
        ...
        <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 advertisementCol advertisementCol_2 iphone6AdCol_2 '>
          ...
          <div class='bestPhoneEver bestPhoneEver_2'>
            ...
            <p><span class='boldy bestPhoneBoldy'>Качественный экран</span><br>Устройство оснащено качественным HD-дисплеем Retina с разрешением 
                                                  1334х750 как и на оригинальном iPhone X</p>
          </div>
...
<div class='techParams'>
    <div class='content_1100'>
      ...
      <p class='techSub'>Реплики Apple iPhone X</p>
      <div class='row techParamsRow align-items-center'>
        ...
        <div class='col-12  col-sm-12  col-md-2  col-lg-2  col-xl-2 techParamsCol techParamsCol_3'>
          <div class='imgWrapper_2'>
            <img src='img/iphone-x-space-grey-sku-header.png'>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='content_1100'>
      <div class='row equipmentRow'>
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-5 equipmentCol equipmentCol_1 noPad'>
          ...
          <p class='equipSub'>Полный комплект Apple iPhone X</p>
        ...
        <div class='col-12  col-sm-12  col-md-5  col-lg-5  col-xl-4 offset-xl-1 equipmentCol equipmentCol_2 iPhoneXeqCol_2'>
          <img src='img/iphone-x-box.png'>
          <div class='buttonWrap_1'>
            <a href="#slider"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
          </div>
        </div>
...
<div class='colorTypes'>
    <div class='content_1100'>
      ...
      <p class='colorSubs'>Выбери свой Apple iPhone X</p>
      <div class='row colorTypesRow justify-content-between'>
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-6 colorTypesCol colorTypesCol_1'>
          <div class='imgWrapper_6'>
            <img src='img/fgdsfgsdg.png'>
          </div>
            <p>Black</p>
            <div class='hidden_1'>
            <div class='buttonWrap_1'>
        ...
        <div class='col-12  col-sm-12  col-md-6  col-lg-6  col-xl-6 colorTypesCol colorTypesCol_3'>
          <div class='imgWrapper_6' id='hider'>
            <img src='img/asfasfasf.png'>
          </div>
            <p>White</p>
            <div class='hidden_3'>
            <div class='buttonWrap_1'>
...
<div class='noRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1'>
        ...
        <p class='rivalsSubs'>Apple IPhone X лучший в своем роде</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Смартфон Apple iPhone X (копия) 
          ...
          <li>
            ...
            <p>Оптимальные и эргономичные габариты корпуса 
              Apple iPhone X (копия), восхитительный внешний вид.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
      ...
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol iPhoneXnoRivalsCol_2'>
