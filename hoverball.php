...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Hoverball">
    <meta name="keywords" content="Hoverball, Товары для детей, детские игрушки">
    <meta name="author" content="Denis Yakunin">
    <title>Hoverball</title>
...
<div class='purchase_block_HB'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class=''>Hoverball</h1>
                <p class='gaySubs'>Мировая детская игрушка теперь и в СНГ!</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Hoverball"/>
                    <input type="hidden" name="price" value="5.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/hoverball.html"/>
                    <p>Ваше Имя</p>
    ...
    <div class='content_1100'>
        ...
        <div class='row padBot'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 noPad ForFontSize'>
                <p>Качественные элементы<br>
            ...
            <div class='col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 noPad videoCol'>
                <iframe width="425" height="241" src="https://www.youtube.com/embed/GTBHNax6gU4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="w-100"></div>
        <h1>ЧТО ТАКОЕ HOVERBALL?</h1>
        <div class='row padBot'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 noPad'>
                <p>HOVERBALL— это единственный футбольный мяч который<br> подходит для игры как на открытом воздухе так и в<br> помещении. Вы можете превратить любую поверхность в поле<br> для воздушного футбола. С помощью вентилятора, с нижней<br> части мяча поступает ветер, делая мяч плавающим по полу.<br><br>
                А яркие светодиодные огни делают вашу игру замечательной<br> даже ночью.</p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 noPad videoCol'>
                <div class='wrap_237'>
                    <img src='img/fsdfsdfsdfdsfsd.png'>
                </div>
            </div>
        </div>
        <h1>ХАРАКТЕРИСТИКИ HOVERBALL</h1>
        <div class='row'>
            <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 noPad ForPmargin'>
                <p><span class='mus700'>МАТЕРИАЛ:</span> ABS Пластик</p>
                <p><span class='mus700'>РАЗМЕР:</span> 19.3*19.3*5 см</p>
                <p><span class='mus700'>ПИТАНИЕ:</span> Работает от батарейки ААА (4 шт)</p>
                <p><span class='mus700'>ДОП. ФУНКЦИИ:</span> Встроенный вентилятор, LED подсветка</p>
            </div>

            <div class='col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 noPad videoCol'>
                <div class='wrap_237'>
                    <img src='img/adsdsadasdasasdasdsad.png'>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Hoverball теперь и в Казахстане</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_HB order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
