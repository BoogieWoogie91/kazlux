...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="СТИЛЬНЫЕ НАРУЧНЫЕ ЧАСЫ CURREN WATCH">
    <meta name="keywords" content="CURREN, Элитные часы, Подарок часы, Купить элитные часы">
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/currenslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/currenslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/currenslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/currenslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt hidable2'>СТИЛЬНЫЕ НАРУЧНЫЕ ЧАСЫ CURREN WATCH</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 CurrenOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <h1 class='alignLeftt showable2'>СТИЛЬНЫЕ НАРУЧНЫЕ ЧАСЫ CURREN WATCH</h1>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Curren"/>
            <input type="hidden" name="price" value="8.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/curren.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_curren order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Аксессуары этой торговой марки, несомненно, являются искусством, для людей, знающих толк в часах, 
                        благодаря высокой точности, изысканности и уникальности, все коллекции бренда высоко 
                        ценятся коллекционерами. Все виды данных часов обладают превосходным качеством. 
                        Благодаря этому, ими заинтересовываются личности, обладающие решительным и победным характером.</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "CURREN"</li>
        ...
        <ul class='rightUl'>
          ...
          <li><span class='boldy'>Водозащита:</span> Бытовая</li>
          <li class='last'><span class='boldy'>Диаметр:</span> 50мм</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/cur2.png'>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/currengal1.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/currengal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='purchase_block_curren'>
    <div class='content_1100'>
                <h1>СТИЛЬНЫЕ НАРУЧНЫЕ ЧАСЫ CURREN WATCH</h1>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/1fagUN3a0eM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
