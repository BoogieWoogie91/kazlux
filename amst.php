...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Настоящие мужские часы">
    <meta name="keywords" content="AMST, Элитные часы, Подарок часы, Купить элитные часы">
...
<!--EBANNYI SLICK-->
  <section class="center slider" id="slider">
    <div>
      <img src="img/amstslider1.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/amstslider2.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/amstslider3.png" alt="carouselimg">
    </div>
    <div>
      <img src="img/amstslider1.png" alt="carouselimg">
    </div>
  ...
  <div class='orderThisNow'>
    ...
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class="alignLeftt hidable2">Настоящие мужские часы</h1>
        <p class="alignLeftt hidable2">Ударопрочные водонепроницаемые часы Amst</p>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 AmstOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
        <h1 class="alignLeftt showable2">Настоящие мужские часы</h1>
        <p class="alignstart showable2">Ударопрочные водонепроницаемые часы Amst</p>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="Amst"/>
            <input type="hidden" name="price" value="21.990"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/amst.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_amst order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>15 900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>31 800 тенге</span></p>
          </div>
        </div>
      </div>
...
<div class='characteristics'>
  <div class='content_1100'>
    <div class='row characteristicsRow'>
      ...
      <p class='charP'>Часы Amst - новинка среди ударопрочных часов, которые выдержат самое агрессивное воздействие! 
                        Эти часы сделаны из современных сверхпрочных материалов по специальной технологии 
                        и готовы к любой нагрузке, а уникальный дизайн позволит носить их когда и 
                        где угодно, будь то в офис или вечеринка, конференция или же нереальный экстрим!</p>
      <div class='charLists'>
        <ul>
          <li><span class='boldy'>Бренд:</span> "AMST"</li>
          <li><span class='boldy'>Механизм:</span> Кварцевые (Бельгия)</li>
          <li class='last'><span class='boldy'>Стекло:</span> Сапфировое</li>
        </ul>
        <ul class='rightUl'>
          <li><span class='boldy'>Корпус:</span> Гальванизированная нержавеющая сталь</li>
          <li><span class='boldy'>Браслет:</span> Натуральная кожа</li>
          <li class='last'><span class='boldy'>Вес:</span> 130г</li>
        </ul>
      </div>
      </div>
      <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 characteristicsCol characteristicsCol_2'>
        <div class='imgWrap_10'>
          <img src='img/DdKEq4HWkAAB0w3.png'>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/amstgal2.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/amstgal3.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='trueFeedbackBlock'>
  ...
  <div class='purchase_block_amst'>
    <div class='content_1100'>
                <h1>УДАРОПРОЧНЫЕ ВОДОНЕПРОНИЦАЕМЫЕ ЧАСЫ AMST</h1>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
                <div class='form'>
                    <form action="form/integration.php" method="post">
                        <input type="hidden" name="tema" value="Amst"/>
                        <input type="hidden" name="price" value="15.900"/>
                        <input type="hidden" name="comments" value="http://kz-luxury.com/amst.html"/>
                        <p>Ваше ФИО</p>
                        <input class='purchaseFormInput' type="text" name='name' placeholder="ФИО">
                        <p>Ваш Телефон</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_amst'>
                <div>
                ...
                <div class='insidePicCol_tag36'>
                    <img src="img/DdKEq4HWkAAB0w31111.png">
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/ZosN17zbszo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
