...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Smart Baby Watch Q100">
    <meta name="keywords" content="Smart Baby Watch Q100, Товары для детей, детские игрушки">
    <meta name="author" content="Denis Yakunin">
    <title>Smart Baby Watch Q100</title>
...
<div class='purchase_block_BW'>
    <div class='content_1100'>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <h1 class='white'>Smart Baby Watch Q100</h1>
                <p class='gaySubsWhite'>С ярким цветным экраном</p>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="Smart Baby Watch Q100"/>
                    <input type="hidden" name="price" value="25.990"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/babywatch.html"/>
                    <p>Ваше Имя</p>
            ...
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_curren'>
                <div class='ffsHorseIsPidor_BW'>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>25 990тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>51 990 тенге</span></p>
                    </div>
                </div>
                </div>
            </div>
    ...
    <div class='toyDescription_BB'>
        <div class='content_1100'>
            <h1>Как отличить Baby Watch Q100 от дешевых подделок?</h1>
            <div class='row'>
                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3'>
                    <div class='wrap_86'>
                        <img src='img/chesi-100x100.png'>
                    </div>
                    <p><b>Большой цветной экран</b><br>Смарт Беби Вотч имеет яркий цветной экран. Это отличает ее от предыдущих часов серии, а так же от дешевых подделок.
                        На экране НЕ должно быть кнопки вызова! Если такая кнопка есть, это другая модель часов или подделка.</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3'>
                    <div class='wrap_100'>
                        <img src='img/gps-100x100.png'>
                    </div>
                    <p><b>GPS-передатчик</b><br>Со Smart Baby Watch q100  Вы сможете в режиме онлайн следить на экране смартфона за передвижением ребенка через спутниковые карты (Google, Яндекс). Полная информацию о том, где в данный момент находится Ваш ребенок, без погрешностей.</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3'>
                    <div class='wrap_100'>
                        <img src='img/prai-100x100.png'>
                    </div>
                    <p><b>Разрешенные зоны</b><br>Настраивая детские часы с GPS трекером установите желаемую безопасную зону, например р-н школы, двора и др. При выходе ребенка за границы гео-зоны Вы получаете уведомление и можете перезвонить и уточнить причину и ситуацию.</p>
                </div>

                <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3'>
                    <div class='wrap_100'>
                        <img src='img/zony-100x100.png'>
                    </div>
                    <p><b>Память траектории передвижений</b>Настраивая детские часы с GPS трекером установите желаемую безопасную зону, например р-н школы, двора и др. При выходе ребенка за границы гео-зоны Вы получаете уведомление и можете перезвонить и уточнить причину и ситуацию.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='location'>
        <div class='content_1366'>
            <div class='pikBlockLocation'>
                <div class='content_1100ForReal'>
                    <div class='girlBlock'>                    
                            <h1>Местоположение в режиме онлайн</h1>
                    </div>
                    <div class='GPSBlock'></div>                
                </div>
            </div>
            <div class='blockForButtonLocation'>
...
<div class='noRivals_BB'>
    <div class='content_1100'>
    <h1>Функции детских часов Baby Watch Q100</h1>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair noPad'>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>GPS часы с телефоном</p>
          </li>
        </ul>
        <p>Smart Baby Watch Q100 могут не только принимать звонки, 
        но и осуществлять исходящий вызов на разрешенные номера. 
        Вы назначаете разрешенные номера при настройке часов, 
        например: кнопка №1 - Мама, кнопка "2 - Папа". Ребенок просто 
        и безопасно сможет в любой момент связаться с Вами.</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Яркие, цветные часы</p>
          </li>
        </ul>
        <p>Поверьте, Ваш ребенок с удовольствием будет носить эти 
        часы каждый день! Дети в детском саду или школе будут рады 
        похвастаться ими перед одногруппниками. Ведь таких 
        полезных и умных часов нет ни у кого!</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
        ...
        <p>Предусмотрена функция передачи коротких голосовых сообщений
        через интернет, например сообщений-напоминаний или 
        команда на установку будильника для ребенка дистанционно.</p>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noPad'>
                <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Скрытый вызов устройства</p>
          </li>
        </ul>
        <p>Вы сможете оценить обстановку вокруг ребенка в любой момент. 
            Он не узнает об этом, а Вы будете в курсе его проблем. 
            С данной функцией Вы всегда сможете контролировать то, в каких 
            местах он бывает и что с ним происходит, Вы сможете оперативно 
            помочь ребенку избежать беды и дать правильный совет.</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Новейший блок GPS</p>
          </li>
        </ul>
        <p>Детские смарт часы SMART BABY WATCH Q100 это 
            усовершенствованная по всем параметрам модель популярной серии. 
            В том числе улучшения коснулись самого важного - GPS модуля. 
            Теперь точность без погрешностей!</p>
        <ul class='noRivalsList'>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
        ...
        <p>Модель Q100 имеет функцию кнопки «SOS связи». Малыш сможет 
            незаметно нажать ее, чтобы сообщить вам об опасности. 
            Одно нажатие и вам немедленно поступит звонок. Не теряя времени 
            Вы сможете оперативно принять срочные меры</p>
      </div>
    </div>
</div>
  </div>
...
<div class='reviewBlock'>
    <div class='content_1100'>
        <h1>Видео обзор детских часов</h1>
        <div class='wrap560'>
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/IaromaiaLh4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
</div>
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>Smart Baby Watch Q100</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_BW order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
