...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="БЕСПРОВОДНАЯ ЧУДО-БРИТВА X-TRIM">
    <meta name="keywords" content="X-trim, Товары для красоты, Товары для здоровья">
  ...
  <div class='content_1366'>
    <div class='row wrapper_10Row'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
        <h1 class='alignLeftt h1ForBobby'>БЕСПРОВОДНАЯ ЧУДО-БРИТВА X-TRIM</h1>
      </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
      <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 XtrimOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
          <div class='form_lastBlock'>
            <form action="form/integration.php" method="post">
            <input type="hidden" name="tema" value="X-trim"/>
            <input type="hidden" name="price" value="10.900"/>
            <input type="hidden" name="comments" value="http://kz-luxury.com/xtream.html"/>
            <p>Ваше Имя</p>
      ...
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_xtream order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
        <div class='priceCircle_1 specialPriceCircle'>
          <div class='innerPriceCircle_1'>
            <p>Цена со скидкой</p>
            <p class='price'>10.900тг.</p>
            <p>Старая цена:<br><span class='lineThrough'>21 800 тенге</span></p>
          </div>
        </div>
      </div>
      <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 orderThisNowCol orderThisNowCol_3 orderThisNowCol_3_xtream order-3 order-sm-3 order-md-3 order-lg-3 order-xl-3'>
...
<div class='howThisShitWorks'>
   <div class='content_1100'>
    <h1 class='xtrimh1'>КАК РАБОТАЕТ ЧУДО-БРИТВА X-TRIM?</h1>
    <p class='xtrimp'>Прорыв в сфере парикмахерских технологий</p>
       <div class='row'>
           <div class='col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 howItWorks_Col_1'>
               <img src='img/sfdsdgljksdfhkjfds.png'>
           </div>

           <div class='col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 howItWorks_Col_1'>
               <iframe width="560" height="315" src="https://www.youtube.com/embed/K9AlLZVEHaw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           </div>
       </div>
        <div class='buttonWrap_1'>
            <a href="#form"><div class="buttonChanger">Получить консультацию</div></a>
        </div>
   </div> 
</div>


<div class='noRivals xtreamNoRivals'>
    <div class='row noRivalsRow'>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol noRivalsCol_1 noRivalsCol_1_fastHair'>
        <h1>ПОЧЕМУ X-TRIM ЛУЧШЕ ОБЫЧНОЙ БРИТВЫ?</h1>
        <p class='rivalsSubs'>Особенности</p>
        <ul class='noRivalsList'>
            <h4>ЧУДО-БРИТВА X-TRIM</h4>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Не требует воды для бритья, пены или лосьона.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Нет риска поранить/порезать кожу, не 
                оставляет раздражения на коже</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Не требует постоянной подзарядки или 
                электричества, работает от батареек</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Удобнее и точнее обычной бритвы. 
                Идеальный стайлинг бороды и усов.</p>
          </li>
        </ul>
        <div class='buttonWrap_1'>
          <a href="#form"><div class="buttonChanger">Заказать сейчас</div></a>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 noRivalsCol xtrimNoRivalsCol_2'>
        <ul class='noRivalsList noMarRivalsList'>
            <h4>ОБЫЧНАЯ БРИТВА</h4>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Необходима вода, а также дополнительные 
          ...
          <li>
            ...
            <p>Имеет непосредственный контакт с кожей, 
                поэтому травмирует ее.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>При частом бритье приходиться часто покупать 
                дорогие кассеты с лезвиями.</p>
          </li>
          <li>
            <div class='imgWrapper'>
              <img src='img/tick-inside-circle copy 11.png'>
            </div>
            <p>Неудобно корректировать форму и 
                длину бороды и усов</p>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class='beautyAdvantages'>
    <div class='content_1100'>
        <h1>Преимущества</h1>
        <p class='rivalsSubs'>Беспроводной чудо-бритвы X-trim</p>
      <div class='row'>
        <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 beautyAdvCol'>
          <div class='advContainer'>
            <img src='img/01.png'>
            <h1 class='advantageContent'>УДОБСТВО</h1>
          </div>
          <p>Гладкая ребристая ручка прочно лежит в руке, обеспечивая 100%-ую точность движений, а благодаря яркой подсветке Вы не пропустите ни одного волоска.</p>
        </div>

        <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 beautyAdvCol'>
          <div class='advContainer'>
            <img src='img/02.png'>
            <h1 class='advantageContent'>БЕЗОПАСНОСТЬ</h1>
          </div>
          <p>X-TRIM — безопасная альтернатива ножницам и бритве. Удалять ей волосы из ушей и носа намного безопаснее, чем с помощью привычной бритвы.</p>
        </div>
        ...
        <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 beautyAdvCol'>
          <div class='advContainer'>
            <img src='img/03.png'>
            <h1 class='advantageContent'>КОМПАКТНОСТЬ</h1>
          </div>
          <p>Бритва X-TRIM — легкая и компактная. Её удобно брать с собой в командировку либо на отдых. Работает от батареек, не требует геля, пены или лосьона.</p>
        </div>

        <div class='col-12  col-sm-12  col-md-12  col-lg-6  col-xl-6 beautyAdvCol'>
          <div class='advContainer'>
            <img src='img/04.png'>
            <h1 class='advantageContent'>ФУНКЦИОНАЛЬНОСТЬ</h1>
          </div>
          <p>С помощью X-TRIM можно не только удалять волосы с лица, но и подравнять бакенбарды, линию волос вокруг ушей или сбрить лишние волосы на шее.</p>
        </div>
      </div>
    </div>
  </div>

  <div class='qualities noPadQualit'>
  <div class='content_1100'>
    <h1 class='fasthairh1 marginBot'>ХАРАКТЕРИСТИКИ:</h1>
    <div class='row qualitiesRow'>
      <div class='col-12  col-sm-12  col-md-4  col-lg-4  col-xl-4 margincolumn fastHairColumn_1 fastHairColumn_1_again xtreamCol_1'>
        <img src='img/b5-min.png'>
      </div>
      <div class='col-12  col-sm-12  col-md-8  col-lg-8  col-xl-8 fastHairQualitiesText'>
        <div class='advContainer_1'>
          <img src='img/011.png'>
          <p class='advantageContentP'>Материал изготовления корпуса: долговечный пластик.<br>
                                       Материал изготовления ножей: высококачественная нержавеющая сталь.</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/022.png'>
          <p class='advantageContentP additionalMarginP'>4 сменные насадки.</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/033.png'>
          <p class='advantageContentP additionalMarginP'>Светодиодная подсветка.</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/044.png'>
          <p class='advantageContentP additionalMarginP'>Питание: от двух батареек типа ААА (нет в комплекте).</p>
        </div>
      </div>
    </div>

    <div class='row qualitiesRow xtreamQualitiesRow'>
      <div class='col-12  col-sm-12  col-md-7  col-lg-6  col-xl-6 fastHairQualitiesText'>
        <h5 class='charsH5'>КОМПЛЕКТАЦИЯ:</h5>
        <div class='advContainer_1'>
          <img src='img/011.png'>
          <p class='advantageContentP marginTopGoes'>Бритва X-TRIM;</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/022.png'>
          <p class='advantageContentP marginTopGoes'>Микронасадка (6, 4 и 2 мм);</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/033.png'>
          <p class='advantageContentP marginTopGoes'>Насадка-расческа для стрижки волос;</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/044.png'>
          <p class='advantageContentP marginTopGoes'>Насадка-триммер средняя;</p>
        </div>

        <div class='advContainer_1'>
          <img src='img/055.png'>
          <p class='advantageContentP marginTopGoes'>Кисточка, инструкция;</p>
        </div>
         <div class='buttonWrap_1'>
            <a href="#form"><div class="buttonChanger">Заказать 10 900тг</div></a>
        </div>
      </div>
      <div class='col-12  col-sm-12  col-md-5  col-lg-6  col-xl-6 margincolumn xtreamHairColumn_1'>
        <img src='img/sdfasdgsdag.png'>
      </div>
    </div>
</div>
</div>
...
<div class='supposedToMakeUbuy'>
    ...
    <div class='buttonWrap_1'>
      <a href="#form"><div class="buttonChanger">ЗАКАЗАТЬ</div></a>
    </div>
  </div>
</div>
...
<div class='purchase_block_xtream'>
    <div class='content_1100'>
                <h1>БЕСПРОВОДНАЯ ЧУДО-БРИТВА X-TRIM</h1>
                <p class='gaySubsWhite'>ИДЕАЛЬНАЯ, УХОЖЕННАЯ ВНЕШНОСТЬ ВСЕГО ЗА 2 МИНУТЫ</p>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-4 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol formCol_fastHair'>
                <div class='form' id='form'>
                    <form action="form/integration.php" method="post">
                        ...
                        <input type="hidden" name="comments" value="http://kz-luxury.com/xtream.html"/>
                        <p>Ваше ФИО</p>
                        <input class='purchaseFormInput' type="text" name='name' placeholder="Имя">
                        <p>Ваш Телефон</p>
                        <input class='purchaseFormInput' type="text" name='phone' placeholder="+7 (7XX) XXX XX XX" id='phone2'>
                        <div class='buttonWrap'>
                            <button type='submit' class='purchaseFormButton'>ЗАКАЗАТЬ В ОДИН КЛИК</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class='col-12 offset-0 col-sm-6 offset-sm-0 col-md-8 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_xtrim'>
                <div>
                <div class='priceCircle_1_tag36_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>10 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>21 800 тенге</span></p>
                ...
                <div class='insidePicCol_tag36'>
                    <img class='showableImg' src="img/britvaDlyaChlenov.png">
                </div>
            </div>
        </div>
    </div>
