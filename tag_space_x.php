...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="ЗАКАЖИ TAG HEUER SPACE X">
    <meta name="keywords" content="Tag Space X, Элитные часы, Подарок часы, Купить элитные часы">
    <meta name="author" content="Denis Yakunin">
    <title>Tag Space X</title>
...
<section class="center slider"id="slider">
    <div>
        <img src="img/space_x_1.png">
    </div>
    <div>
        <img src="img/space_x_2.png">
    </div>
    <div>
        <img src="img/space_x_3.png">
    </div>
    <div>
        <img src="img/space_x_1.png">
    </div>
...
<div class='orderThisNow'>
    ...
    <div class='row wrapper_10Row'>
        <div class='col-12 col-sm-12 col-md-12 col-lg-7 col-xl-6 offset-xl-1'>
            <h1 class='alignLeftt hidable2'>ЗАКАЖИ TAG HEUER SPACE X</h1>
        </div>
    </div>
    <div class='row orderThisNowRow align-items-start'>
        <div class='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 offset-xl-1 orderThisNowCol orderThisNowCol_1 SpaceXOrderThisNowCol_1 order-2 order-sm-2 order-md-2 order-lg-1 order-xl-1'>
            <h1 class='alignLeftt showable2'>ЗАКАЖИ TAG HEUER SPACE X</h1>
            <div class='form_lastBlock'>
                <form action="form/integration.php" method="post">
                    <input type="hidden" name="tema" value="tag SpaceX"/>
                    <input type="hidden" name="price" value="19.900"/>
                    <input type="hidden" name="comments" value="http://kz-luxury.com/tag_space_x.html"/>
                    <p>Ваше Имя</p>
        ...
        <div class='col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 orderThisNowCol orderThisNowCol_2_tagSpaceX order-1 order-sm-1 order-md-1 order-lg-2 order-xl-2'>
    ...
    <div class='content_1100'>
        <div class='row characteristicsRow'>
            <div class='col-12 col-sm-12 col-md-6 col-lg-6 col-xl-8 characteristicsCol characteristicsCol_1'>
                ...
                <p class='charP'>Хронометры этой торговой марки, несомненно, являются искусством, для людей, знающих толк в часах,
                    благодаря высокой точности, изысканности и уникальности, все коллекции бренда высоко ценятся
                    коллекционерами. Все виды данных часов обладают превосходным качеством.<br>
    ...
    <div class='row galleryRow'>
      ...
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_19'>
          <img src='img/lksdgjklsgd.png'>
        </div>
      </div>
      <div class='col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 galleryCol'>
        <div class='imgWrap_20'>
          <img src='img/ddgsgdg.png'>
        </div>
      </div>
    </div>
  </div>
...
<div class='purchase_block_tagSpaceX'>
    <div class='content_1100'>
        <h1 class='hidable1'>TAG HEUER SPACE X</h1>
        <div class='row purchaseRow'>
            <div class='col-12 offset-0 col-sm-12 offset-sm-0 col-md-6 offset-md-0 col-lg-4 offset-lg-0 col-xl-4 formCol'>
                <div class='form'>
                    <form action="form/integration.php" method="post">
                        <input type="hidden" name="tema" value="tag space_x"/>
                        <input type="hidden" name="price" value="19.900"/>
                        <input type="hidden" name="comments" value="http://kz-luxury.com/tag_space_x.html"/>
                        <p>Ваше ФИО</p>
            ...
            <div class='col-12 offset-0 col-sm-12 offset-sm-0 col-md-6 offset-md-0 col-lg-8 offset-lg-0 col-xl-8 offset-xl-0 picCol_tag_space_x'>
                <div>
                <h1 class='showable1'>TAG HEUER SPACE X</h1>
                <div class='priceCircle_1_tagSpaceX_1'>
                    <div class='innerPriceCircle_1'>
                        <p>Цена со скидкой</p>
                        <p class='price'>19 900тг.</p>
                        <p>Старая цена:<br><span class='lineThrough'>66 335 тенге</span></p>
                    </div>
                </div>
                </div>
                <div class='insidePicCol_tagSpaceX'>
                    <img src="img/dgsgsgsdgsggds.png">
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <iframe width="1000" height="600" src="https://www.youtube.com/embed/XpUWQSE30Zc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div>
                    </div>
                  </div>
                </div>
